...
const PLANS = [
  ...
  },
  {
    ...
    cta:      'Contratar',
    ctaHref:  '/sign-up',
    features: ['1 usuario', '1 workspace', 'Studio completo', 'Arkos IA', 'Misiones ilimitadas', 'Firma digital OTP', 'Facturación + fiscal', 'Soporte por email'],
  },
  {
    name:     'Starter',
    monthly:  39,
  ...
  },
  {
    ...
    ctaHref:     '/sign-up',
    highlighted: true,
    features:    ['Hasta 15 usuarios', '3 workspaces', 'Studio completo', 'Arkos IA avanzado', 'Misiones + Flujos', 'Firma digital OTP', 'Historial de auditoría', 'Soporte prioritario'],
  },
  {
    name:     'Business',
    monthly:  349,
