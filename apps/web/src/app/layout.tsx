    ...
    >
      <html lang={locale} suppressHydrationWarning>
        ...
        <body className={inter.className} suppressHydrationWarning>
          <div role="banner" aria-label="Estado de la aplicación" className="w-full bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 text-white text-center text-xs font-semibold py-2 px-4 flex items-center justify-center gap-2 tracking-wide shadow-sm">
