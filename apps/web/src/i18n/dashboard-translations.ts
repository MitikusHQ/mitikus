...
const en: DashboardTranslations = {
  ...
  descCopilot: 'Your strategic advisor â€” share your goals and it helps you plan them',
  descBrain: 'Query the workspace memory â€” documents, goals and decisions',
  ...
  descReceipts: 'Scan tickets and invoices with the camera â€” AI extracts the data',
  ...
  bannerCta: 'Limited spots Â· Join now and lock in your launch price',
  ...
  toolCsvOnlyUtf8: 'CSV files only Â· UTF-8',
  ...
  toolSettingsTemperatureHint: '0 = deterministic and precise Â· 1 = more creative and varied',
  ...
  toolSettingsSystemPromptOverrideHint: 'Advanced â€” completely replaces the generated system prompt. Leave empty to use the tool automatic prompt.',
  ...
  brainDescription: 'Query your workspace memory â€” documents, goals, conversations and tools.',
  brainTabBrain: 'Brain',
  ...
  brainLocalTitlePlaceholder: 'Base memory â€” project topic',
  ...
  officeFilesUpgradeStorage: 'Upgrade your storage â€” â‚¬2/GB/month',
  ...
  officeFilesUploadHelp: 'PDF, DOCX, XLSX, images, TXT, MD, JSON, ZIP â€” max. 50 MB',
  ...
  // Leads
  leadsTitle: 'Leads',
  leadsSubtitle: 'Potential clients â€” captured from your public form.',
  leadsAll: 'All',
  ...
  leadsConverted: 'âœ“ Converted to client',
  ...
  historyRerun: 'â†» Re-run',
  historyView: 'View',
  historyRetry: 'â†» Retry',
  ...
  officeAnnual: 'Annual',
  officeSeeCalendar: 'See calendar â†’',
  ...
  // Audit
  auditTitle: 'Audit',
  auditSubtitlePrefix: 'Audit trail Â· ',
  ...
  workflowsStep1Description: 'Combine any installed tool in your workspace: analyzers, generators, data extractorsâ€¦',
  ...
  // Home/workspace page
  homePanelSubtitle: 'Panel â€” what is most important for you to do today',
  homeMissionsTitle: 'Active missions',
  homeCreateMission: 'Create mission â†’',
  ...
  homeResolveBlocker: 'Resolve blocker â†’',
  homeNoMissions: 'No active missions.',
  homeNoMissionsDesc: 'Tell Arkos a business goal and it will turn it into a mission with clear steps â€” or use a template to start instantly.',
  homeDefineWithArkos: 'Define with Arkos â†’',
  ...
  templateSteps: 'steps',
  templateBackToList: 'â† Back to templates',
  templateIncludedStepsPrefix: 'Included steps (',
  templateActorAI: 'âœ¨ AI',
  templateActorShared: 'ðŸ¤ Shared',
  templateActorUser: 'ðŸ‘¤ You',
  templateMinutes: 'min',
  ...
  searchPlaceholder: 'Search across documents, clients, contractsâ€¦',
  ...
  searchMinChars: 'Type at least 2 characters Â· Search across documents, PDFs, contracts, sheets, presentations, tasks, missions, clients and tools',
  ...
  tasksCreateFirst: 'Create the first â†’',
  ...
  invoicesReviewingReplies: 'Checkingâ€¦',
  ...
  invoicesRectPlaceholder: 'E.g. Amount error, partial refundâ€¦',
  invoicesRectCancel: 'Cancel',
  invoicesRectCreate: 'Create credit note',
  invoicesRectCreating: 'Creatingâ€¦',
  ...
  invoicesSending: 'Sendingâ€¦',
  invoicesSentOk: 'âœ“ Invoice sent successfully.',
  invoicesSendError: 'Could not send the invoice. Check that you have email configured in Settings â†’ Email.',
  invoicesSendErrorSettings: 'Settings â†’ Email',
  ...
  wsEmailTesting: 'Testingâ€¦',
  wsEmailTestOk: 'âœ“ Connection OK',
  wsEmailSave: 'Save email',
  wsEmailSaving: 'Savingâ€¦',
  wsEmailSaved: 'âœ“ Saved',
  ...
  wsPermOnlyAdminsActive: 'Active â€” Editors and below cannot install tools or create missions.',
  wsPermOnlyAdminsInactive: 'Disabled â€” All Editors can install tools and create missions.',
  wsPermOwnerOnly: 'Only the workspace Owner can change this setting.',
  wsPermSaved: 'âœ“ Saved',
  wsSave: 'Save changes',
  wsSaving: 'Savingâ€¦',
  wsSaved: 'âœ“ Saved',
  // Receipts page
  ...
  receiptsSubtitle: 'Scan receipts and invoices â€” AI extracts the data automatically',
  // ReceiptsClient
  ...
  receiptsScanExtracted: 'Extracted data â€” review and correct if needed',
  ...
  receiptsScanNotesPlaceholder: 'Additional notesâ€¦',
  ...
  profileAvatarSaved: 'âœ“ Photo updated',
  profileInfoSection: 'Information',
  profileName: 'Full name',
  profileEmail: 'Email',
  profileJobTitle: 'Job title',
  profileJobTitlePlaceholder: 'E.g. CEO, Designer, Freelancerâ€¦',
  profileSave: 'Save',
  profileSaving: 'Savingâ€¦',
  profileSaved: 'âœ“ Saved',
  ...
  wfDescPlaceholder: 'e.g. SWOT â†’ Competitive analysis â†’ Action plan â†’ Executive report',
  wfCreate: 'Create and open editor â†’',
  wfCreating: 'Creatingâ€¦',
  ...
  usageManageFiles: 'Manage files â†’',
  ...
  usageViewContracts: 'View contracts â†’',
  usageViewInvoices: 'View invoices â†’',
  ...
  teamInvitePlaceholder: 'Email (optional â€” leave blank to generate a link)',
  teamExpired: 'âš  Expired',
  teamExpires: 'Expires',
  teamOpenLink: 'Open link',
  teamLoading: 'Loadingâ€¦',
...
const es: DashboardTranslations = {
  ...
  navPayroll: 'NÃ³minas',
  navLeaves: 'Permisos',
  descEmployees: 'Gestiona tu equipo, contratos y configuraciÃ³n de nÃ³minas',
  descPayroll: 'Genera y aprueba nÃ³minas mensuales',
  descLeaves: 'Gestiona vacaciones, bajas y ausencias',
  employeesTitle: 'Empleados',
  employeesSubtitle: 'Gestiona tu equipo y configuraciÃ³n de nÃ³minas',
  payrollTitle: 'NÃ³minas',
  payrollSubtitle: 'GeneraciÃ³n y aprobaciÃ³n de nÃ³minas mensuales',
  leavesTitle: 'Ausencias y vacaciones',
  leavesSubtitle: 'GestiÃ³n de solicitudes de ausencia y calendario laboral',
  docsTitle: 'DocumentaciÃ³n',
  docsSubtitle: 'Base de conocimiento del workspace',
  sheetsTitle: 'Hojas de cÃ¡lculo',
  sheetsSubtitle: 'Sube .xlsx existentes o crea hojas desde cero',
  descToday: 'Tus tareas pendientes y actividad del equipo de hoy',
  descCopilot: 'Tu asesor estratÃ©gico â€” cuÃ©ntale tus objetivos y te ayuda a planificarlos',
  descBrain: 'Consulta la memoria del workspace â€” documentos, objetivos y decisiones',
  ...
  descLeads: 'Potenciales clientes captados desde tu formulario pÃºblico',
  ...
  descOffice: 'Documentos, hojas de cÃ¡lculo, PDFs, contratos y presentaciones',
  descFiles: 'AlmacÃ©n de archivos del workspace con exportaciÃ³n ZIP',
  filesTitle: 'Archivos',
  ...
  filesStorageLimitError: 'Has alcanzado el lÃ­mite de almacenamiento de tu plan.',
  filesSizeLimitError: 'El archivo supera el lÃ­mite de 50 MB.',
  filesUploadError: 'Error al subir el archivo.',
  filesConnectionError: 'Error de conexiÃ³n. IntÃ©ntalo de nuevo.',
  ...
  filesDropPrefix: 'Arrastra un archivo aquÃ­ o',
  filesDropAction: 'elige uno',
  filesMaxSize: 'MÃ¡ximo 50 MB por archivo',
  filesEmpty: 'AÃºn no hay archivos en este workspace.',
  ...
  pdfsConnectionError: 'Error de conexiÃ³n. IntÃ©ntalo de nuevo.',
  pdfsSelectFileAria: 'Seleccionar archivo PDF',
  pdfsProcessing: 'Procesando...',
  pdfsDropPrefix: 'Arrastra un',
  pdfsDropAction: 'aquÃ­ o',
  pdfsChooseFile: 'elige archivo',
  pdfsEmptyInCategory: 'Sin PDFs en "{category}"',
  pdfsEmpty: 'Sin PDFs todavÃ­a',
  pdfsEmptyFilteredHelp: 'Prueba otra categorÃ­a o sube un PDF nuevo.',
  pdfsEmptyHelp: 'Arrastra un PDF en la zona de carga superior para empezar.',
  pdfsPageSingular: 'pÃ¡gina',
  pdfsPagePlural: 'pÃ¡ginas',
  pdfsUntitled: 'Sin tÃ­tulo',
  pdfsTitleAria: 'TÃ­tulo del PDF',
  pdfsCategoryAria: 'CategorÃ­a',
  pdfsNoCategory: 'Sin categorÃ­a',
  pdfsSave: 'Guardar',
  pdfsPageShortSingular: 'pÃ¡g.',
  pdfsPageShortPlural: 'pÃ¡gs.',
  ...
  pdfsDeleteConfirm: 'Â¿Eliminar este PDF? Esta acciÃ³n no se puede deshacer.',
  pdfsDeleting: 'Eliminando...',
  pdfsDelete: 'Eliminar PDF',
  pdfsGoToPageAria: 'Ir a pÃ¡gina {page}',
  pdfsPagesShort: 'PÃ¡gs',
  ...
  pdfsPreviousPage: 'PÃ¡gina anterior',
  pdfsNextPage: 'PÃ¡gina siguiente',
  pdfsPageAbbrev: 'PÃ¡g',
  ...
  timelogSubtitle: 'Registro de jornada e imputaciÃ³n de horas',
  ...
  timelogTotal: 'Total',
  timelogNoImputations: 'Sin imputaciones para este dÃ­a.',
  timelogDeleteImputation: 'Eliminar imputaciÃ³n',
  timelogMissionOptional: 'MisiÃ³n (opcional)',
  timelogNoMission: 'Sin misiÃ³n',
  timelogClientOptional: 'Cliente (opcional)',
  timelogNoClient: 'Sin cliente',
  timelogHours: 'Horas *',
  timelogHoursPlaceholder: 'ej. 2.5',
  timelogDescription: 'DescripciÃ³n',
  timelogDescriptionPlaceholder: 'ej. ReuniÃ³n de kick-off',
  timelogCancel: 'Cancelar',
  timelogAdd: 'AÃ±adir',
  timelogAdding: 'AÃ±adiendo...',
  timelogAddImputation: '+ AÃ±adir imputaciÃ³n',
  timelogInvalidHours: 'Introduce un nÃºmero de horas vÃ¡lido (0.5 - 24)',
  timelogAddError: 'No se pudo aÃ±adir la imputaciÃ³n. IntÃ©ntalo de nuevo.',
  timelogDeleteError: 'No se pudo eliminar la imputaciÃ³n. IntÃ©ntalo de nuevo.',
  timelogEditTitle: 'Editar fichaje',
  timelogClockIn: 'Entrada',
  timelogClockOut: 'Salida',
  timelogEditReason: 'Motivo de correcciÃ³n *',
  timelogEditReasonPlaceholder: 'ej. OlvidÃ© fichar la salida',
  timelogEditReasonRequired: 'El motivo de correcciÃ³n es obligatorio',
  timelogClockOutRequired: 'Indica la hora de salida',
  timelogSaveError: 'No se pudo guardar la entrada. IntÃ©ntalo de nuevo.',
  timelogSave: 'Guardar',
  ...
  timelogDaySat: 'SÃ¡b',
  timelogDaySun: 'Dom',
  importTitle: 'Centro de importaciÃ³n',
  importSubtitle: 'Convierte cualquier archivo en una herramienta MITIKUS',
  importExcelDescription: 'Hojas de cÃ¡lculo con campos, tablas y listas',
  importCsvDescription: 'Datos tabulares separados por comas o punto y coma',
  importJsonDescription: 'JSON genÃ©rico o ToolSchema MITIKUS directamente',
  importWordDescription: 'Documentos con encabezados, formularios y listas',
  importPdfDescription: 'Formularios y documentos con texto extraÃ­ble',
  importMarkdownDescription: 'GuÃ­as, checklists y documentos tÃ©cnicos',
  ...
  importDropTitle: 'Arrastra tu archivo aquÃ­',
  importDropSubtitle: 'Excel, CSV, JSON, Word, PDF, Markdown - mÃ¡ximo 20 MB',
  ...
  importAvailableInCatalog: 'Ya estÃ¡ disponible en tu catÃ¡logo',
  importViewTools: 'Ver herramientas',
  importAnother: 'Importar otro',
  descMissions: 'Objetivos estratÃ©gicos y sus pasos de ejecuciÃ³n',
  ...
  descReceipts: 'Escanea tickets y facturas con la cÃ¡mara â€” la IA extrae los datos',
  descAnalytics: 'Actividad, ejecuciones y costes de tu workspace',
  descUsage: 'CuÃ¡nto has generado este mes y cuÃ¡nto te queda de tu plan',
  descAudit: 'Registro de quiÃ©n hizo quÃ© y cuÃ¡ndo en este workspace',
  descAdminOrg: 'Miembros, planes y configuraciÃ³n de tu organizaciÃ³n',
  ...
  bannerCta: 'Plazas limitadas Â· Ãšnete ahora y bloquea tu precio de lanzamiento',
  todayGreetingMorning: 'Buenos dÃ­as',
  ...
  todayArkosStepDescription: 'CuÃ©ntale quÃ© hace tu empresa para que pueda ayudarte a planificar.',
  todayClientStepTitle: 'AÃ±ade tu primer cliente',
  ...
  todayFiscalStepDescription: 'Configura tu forma jurÃ­dica para ver tus obligaciones tributarias.',
  todayTimeTracking: 'Control horario',
  todayViewHistory: 'Ver historial',
  todayMyTasks: 'Mis tareas',
  todayViewAll: 'Ver todas',
  todayAllCaughtUpTitle: 'Todo al dÃ­a. Buen trabajo.',
  todayAllCaughtUpDescription: 'No tienes pasos ni workflows pendientes.',
  todayAskArkosMission: 'Pedir a Arkos una nueva misiÃ³n',
  ...
  todayClockInError: 'No se pudo registrar la entrada. IntÃ©ntalo de nuevo.',
  todayClockOutError: 'No se pudo registrar la salida. IntÃ©ntalo de nuevo.',
  ...
  todayFiscalSetupDescription: 'Activa el calendario de obligaciones tributarias para tu forma jurÃ­dica.',
  todayConfigure: 'Configurar',
  todayUpcomingFiscal: 'PrÃ³ximas obligaciones fiscales',
  ...
  copilotSetupPrompt: 'CuÃ©ntame en quÃ© quieres trabajar hoy.',
  ...
  copilotEmptyCompany: 'AÃºn no tengo datos sobre tu empresa. CuÃ©ntame en quÃ© trabajas y los irÃ© aprendiendo.',
  copilotCompanyName: 'Empresa',
  copilotSector: 'Sector',
  copilotCountry: 'PaÃ­s',
  copilotSize: 'TamaÃ±o',
  ...
  copilotSizeSmall: 'PequeÃ±a (10-49)',
  ...
  copilotMaturityLeading: 'LÃ­der digital',
  copilotConnectionError: 'Error de conexiÃ³n.',
  copilotPlanSelectError: 'Error seleccionando plan.',
  copilotWelcomeTitle: 'Â¡Hola! Soy Arkos, tu copiloto estratÃ©gico.',
  copilotWelcomeDescriptionPrefix: 'Para ayudarte de verdad necesito conocer tu negocio. ',
  copilotWelcomeDescriptionStrong: 'DescrÃ­beme en una frase a quÃ© te dedicas',
  copilotWelcomeDescriptionSuffix: ' y empezamos.',
  copilotQuickExamples: 'Ejemplos - elige uno o escribe el tuyo',
  copilotInitialPromptAgency: 'Somos una agencia de diseÃ±o freelance especializada en branding',
  ...
  copilotInitialWithContext: 'Dime en quÃ© objetivo quieres trabajar hoy o elige una sugerencia. Lo convertirÃ© en una misiÃ³n con pasos claros.',
  copilotMaybeYouMeant: 'QuizÃ¡s te referÃ­as a alguno de estos:',
  copilotClarifyPlaceholder: 'Responde o elige una opciÃ³n arriba...',
  ...
  copilotSend: 'Enviar',
  copilotNew: 'Nuevo',
  copilotNoMoreSuggestions: 'No hay mÃ¡s sugerencias.',
  copilotWriteDirectly: 'EscrÃ­beme directamente en quÃ© quieres trabajar.',
  ...
  copilotSteps: 'pasos',
  copilotDaySingular: 'dÃ­a',
  copilotDayPlural: 'dÃ­as',
  copilotRisk: 'Riesgo',
  copilotRiskLow: 'bajo',
  copilotRiskMedium: 'medio',
  copilotRiskHigh: 'alto',
  copilotChooseStrategy: 'Elegir esta estrategia',
  copilotMissionCreated: 'MisiÃ³n creada con todos sus pasos',
  copilotMissionReady: 'Los pasos del plan estÃ¡n listos en Panel.',
  copilotViewMission: 'Ver la misiÃ³n',
  ...
  mailAttachmentsNote: 'Los adjuntos generales se aÃ±adirÃ¡n en una siguiente mejora. Las facturas ya se envÃ­an con su PDF adjunto desde Facturas.',
  mailSaveDraft: 'Guardar borrador',
  mailSend: 'Enviar',
  mailReply: 'Responder',
  mailDelete: 'Eliminar',
  mailDeletePermanent: 'Eliminar definitivamente',
  mailDeleteConfirm: 'Â¿Mover este correo a la Papelera?',
  mailDeletePermanentConfirm: 'Â¿Eliminar este correo definitivamente?',
  ...
  mailSendError: 'No se ha podido enviar el correo. Comprueba la configuraciÃ³n SMTP en Ajustes.',
  mailDraftError: 'No se ha podido guardar el borrador.',
  mailDeleteError: 'No se ha podido eliminar este correo.',
  mailNoReplyError: 'Este correo no tiene una direcciÃ³n a la que responder.',
  mailImportNotice: 'correo(s) nuevo(s) importado(s).',
  mailImportPartialNotice: 'correo(s) importado(s), pero hubo algÃºn error al leer otros mensajes.',
  mailUpToDate: 'Recibidos al dÃ­a. No hay mensajes nuevos.',
  mailSyncError: 'No se ha podido actualizar Recibidos. Comprueba IMAP en Ajustes.',
  mailNoSmtpNoImap: 'El correo no estÃ¡ configurado.',
  ...
  mailQuotedOn: 'El',
  mailQuotedWrote: 'escribiÃ³',
  toolsInstalledTitle: 'Herramientas instaladas',
  toolsInstalledDescription: 'PequeÃ±as apps para tareas concretas de tu negocio: auditorÃ­as, checklists, informes...',
  toolsGenerate: 'Generar',
  toolsAdd: 'AÃ±adir',
  toolsActive: 'Activa',
  toolsOpen: 'Abrir',
  toolsCategoryAudit: 'AuditorÃ­a',
  toolsCategoryEvaluation: 'EvaluaciÃ³n',
  toolsCategoryChecklist: 'Checklist',
  toolsCategoryCrm: 'CRM',
  ...
  toolsEmptyDescription: 'En menos de un minuto tendrÃ¡s una auditorÃ­a lista para ejecutar con tu primer cliente.',
  toolsInstalling: 'Instalando...',
  toolsViewCatalog: 'Ver catÃ¡logo completo',
  toolsShortcutItAudit: 'AuditorÃ­a de seguridad IT',
  ...
  toolsShortcutDigitalMaturityDescription: 'Nivel de digitalizaciÃ³n y prioridades de transformaciÃ³n.',
  toolsShortcutPopular: 'La mÃ¡s popular',
  toolInvalidSchema: 'Schema de herramienta invÃ¡lido.',
  toolNewEntry: 'Nueva entrada',
  toolAiIdeas: 'Ideas con IA',
  toolImportCsv: 'Importar CSV',
  toolNoRecords: 'AÃºn no hay registros en esta herramienta.',
  toolType: 'Tipo',
  toolDate: 'Fecha',
  ...
  toolDeleteConfirm: 'Â¿Eliminar este registro? Esta acciÃ³n no se puede deshacer.',
  ...
  toolExecutionErrorTitle: 'Error en la ejecuciÃ³n',
  toolUnknownError: 'Error desconocido',
  toolConnectionError: 'Error de conexiÃ³n. IntÃ©ntalo de nuevo.',
  toolMetaModel: 'Modelo',
  toolMetaTokens: 'Tokens',
  toolMetaCost: 'Coste',
  toolMetaTime: 'Tiempo',
  toolMissionUpdateError: 'No se pudo actualizar la misiÃ³n. IntÃ©ntalo de nuevo.',
  toolSaveSocialTitle: 'Guardar esta idea como publicaciÃ³n',
  ...
  toolMissionStepGenerated: 'Resultado generado: esto completa el paso de tu misiÃ³n.',
  toolMissionStepGeneratedDescription: 'Vuelve a la misiÃ³n para marcarlo como hecho. El progreso y la siguiente acciÃ³n se actualizan solos.',
  toolUpdatingMission: 'Actualizando misiÃ³n...',
  toolBackToMissionDone: 'Volver a la misiÃ³n y marcar como hecho',
  toolContinueWith: 'Â¿Continuar con...?',
  toolUse: 'Usar',
  toolNewExecution: 'Nueva ejecuciÃ³n',
  toolBackWithoutDone: 'Volver sin marcar como hecho',
  toolHistoryTitle: 'Historial de ejecuciones IA',
  toolNoExecutionsYet: 'Sin ejecuciones aÃºn',
  toolHistoryEmptyTitle: 'Sin historial',
  toolHistoryEmptyDescription: 'Las ejecuciones IA aparecerÃ¡n aquÃ­ una vez que ejecutes la herramienta.',
  toolRunNow: 'Ejecutar ahora',
  toolDuration: 'DuraciÃ³n',
  toolRerunTitle: 'Reejecutar con las mismas variables',
  toolRerun: 'Reejecutar',
  toolExecutionSingular: 'ejecuciÃ³n',
  toolExecutionPlural: 'ejecuciones',
  toolNoResult: 'No hay resultado disponible para esta ejecuciÃ³n.',
  toolVariablesUsed: 'Variables utilizadas',
  toolTelemetry: 'TelemetrÃ­a',
  ...
  toolCleanExecution: 'Nueva ejecuciÃ³n limpia',
  ...
  toolCsvEmptyError: 'El fichero estÃ¡ vacÃ­o o no tiene cabeceras.',
  ...
  toolCsvDrop: 'Arrastra un CSV aquÃ­ o haz clic para seleccionar',
  toolCsvOnlyUtf8: 'Solo ficheros .csv Â· UTF-8',
  ...
  toolMissingRequiredColumnsSuffix: 'No se podrÃ¡n importar registros vÃ¡lidos.',
  ...
  toolSkippedReason: 'campos obligatorios vacÃ­os o lÃ­mite de plan',
  ...
  toolApprovalDecision: 'DecisiÃ³n',
  toolApprovalReason: 'Motivo',
  toolApprovalReasonRequired: 'obligatorio',
  toolApprovalReasonPlaceholder: 'Indica el motivo de tu decisiÃ³n...',
  toolApprovalCommentOptional: 'Comentario (opcional)',
  toolApprovalCommentPlaceholder: 'AÃ±ade un comentario a tu decisiÃ³n...',
  ...
  toolSettingsTitle: 'ConfiguraciÃ³n de la instalaciÃ³n',
  ...
  toolSettingsNoClientsYet: 'AÃºn no tienes clientes en este workspace.',
  toolSettingsCreateClient: 'Crear cliente',
  toolSettingsAiModel: 'Modelo IA',
  toolSettingsAiModelDescription: 'Elige el proveedor y modelo que usarÃ¡ esta herramienta al ejecutarse',
  ...
  toolSettingsTemperatureHint: '0 = determinista y preciso Â· 1 = mÃ¡s creativo y variado',
  ...
  toolSettingsOutputDescription: 'Idioma, formato y longitud mÃ¡xima de las respuestas',
  toolSettingsResponseLanguage: 'Idioma de respuesta',
  toolSettingsResponseFormat: 'Formato de respuesta',
  toolSettingsMaxOutputTokens: 'Tokens mÃ¡ximos de salida',
  toolSettingsMaxOutputTokensHint: 'VacÃ­o = mÃ¡ximo del modelo. Reducir limita la longitud de respuesta.',
  toolSettingsMaxModel: 'MÃ¡ximo del modelo',
  toolSettingsCustomInstructions: 'Instrucciones personalizadas',
  toolSettingsCustomInstructionsDescription: 'Ajusta o sustituye el comportamiento de la IA para esta instalaciÃ³n',
  toolSettingsAdditionalInstructions: 'Instrucciones adicionales',
  toolSettingsAdditionalInstructionsHint: 'Se aÃ±aden al final del prompt del sistema. Usa esto para aÃ±adir contexto de tu empresa, formato de salida especÃ­fico, etc.',
  toolSettingsAdditionalInstructionsPlaceholder: 'Ejemplo: Nuestro estilo de informes es conciso y ejecutivo. Siempre incluye una secciÃ³n de prÃ³ximos pasos.',
  toolSettingsSystemPromptOverride: 'Sustituir prompt del sistema completo',
  toolSettingsSystemPromptOverrideHint: 'Avanzado â€” reemplaza por completo el prompt de sistema generado. Deja vacÃ­o para usar el prompt automÃ¡tico de la herramienta.',
  toolSettingsSystemPromptOverridePlaceholder: 'Escribe aquÃ­ el prompt de sistema personalizado (opcional)...',
  toolSettingsChangesNextRun: 'Los cambios se aplican en la prÃ³xima ejecuciÃ³n',
  toolSettingsSaved: 'Guardado',
  toolSettingsSaveConfig: 'Guardar configuraciÃ³n',
  toolStatusPending: 'Pendiente',
  toolStatusRunning: 'Ejecutando...',
  toolStatusCompleted: 'Completado',
  toolStatusFailed: 'Error',
  toolStatusCancelled: 'Cancelado',
  toolSelectPlaceholder: 'Selecciona una opciÃ³n',
  toolFieldRequiredErrorPrefix: 'El campo "',
  toolFieldRequiredErrorSuffix: '" es obligatorio.',
  toolItemRequiredErrorPrefix: 'El Ã­tem "',
  ...
  toolScoringTotal: 'PuntuaciÃ³n total',
  toolScoringPassingMinimum: 'MÃ­nimo para pasar',
  toolScoringUpdate: 'Actualizar evaluaciÃ³n',
  toolScoringSave: 'Guardar evaluaciÃ³n',
  ...
  toolNewScoring: 'Nueva evaluaciÃ³n',
  toolEditScoring: 'Editar evaluaciÃ³n',
  ...
  toolAutoApproveBelowSuffix: 'se aprueban automÃ¡ticamente.',
  toolApprovalWillRemainPending: 'Tu solicitud quedarÃ¡ pendiente de aprobaciÃ³n por un responsable.',
  missionsTitle: 'Misiones',
  missionsDescription: 'Objetivos estratÃ©gicos y su seguimiento de ejecuciÃ³n',
  missionsNewWithArkos: 'Nueva misiÃ³n con Arkos',
  ...
  missionsPriorityCritical: 'CrÃ­tica',
  missionsPriorityHigh: 'Alta',
  missionsPriorityMedium: 'Media',
  missionsPriorityLow: 'Baja',
  missionsEmptyAllTitle: 'AÃºn no hay misiones',
  missionsEmptyFilteredTitle: 'No hay misiones en este estado',
  missionsEmptyDescription: 'Las misiones son objetivos estratÃ©gicos con pasos de ejecuciÃ³n. CrÃ©alas con Arkos o desde el panel principal.',
  missionsCreateFirstWithArkos: 'Crear primera misiÃ³n con Arkos',
  ...
  missionStateWaitingUser: 'Esperando a que continÃºes',
  missionStateWaitingAi: 'La IA estÃ¡ trabajando',
  ...
  missionActorUser: 'TÃº',
  missionActorAi: 'IA',
  missionActorShared: 'Compartido',
  missionDueDate: 'Fecha lÃ­mite',
  missionProgressTitle: 'Progreso de la misiÃ³n',
  ...
  missionImpactCritical: 'CrÃ­tico',
  missionImpactHigh: 'Alto',
  missionImpactMedium: 'Medio',
  missionNextAction: 'PrÃ³xima acciÃ³n',
  missionOpenTool: 'Abrir herramienta',
  missionWhyTitle: 'Por quÃ© importa',
  missionDefaultWhyHigh: 'Esta misiÃ³n estÃ¡ marcada como prioridad alta para el negocio: conviene resolverla cuanto antes.',
  missionDefaultWhyNormal: 'Esta misiÃ³n forma parte de los objetivos activos de la empresa.',
  ...
  missionTimeline: 'LÃ­nea temporal',
  missionStepsTitle: 'Pasos de la misiÃ³n',
  missionLinkedWorkflow: 'Flujo asociado',
  missionLinkedWorkflowTitle: 'Flujo vinculado a esta misiÃ³n',
  missionLinkedWorkflowDescription: 'Ver el proceso automatizado asociado',
  missionOpenWorkflow: 'Abrir flujo',
  missionNeedHelp: 'Â¿Necesitas ayuda con esta misiÃ³n?',
  ...
  missionNoStepsTitle: 'Esta misiÃ³n no tiene pasos definidos todavÃ­a.',
  missionNoStepsDescription: 'Define los pasos para saber exactamente quÃ© hacer, en quÃ© orden y con quÃ© herramienta.',
  ...
  missionAiNextRecommendations: 'Recomendamos a continuaciÃ³n',
  ...
  missionAiError: 'No se pudo generar la sugerencia. IntÃ©ntalo de nuevo.',
  missionAiGeneratingNext: 'Generando recomendaciones de prÃ³ximas misiones...',
  missionAiAskHelp: 'Pide una sugerencia si dudas sobre cÃ³mo continuar.',
  ...
  clientsEmptyTitle: 'AÃ±ade tu primer cliente',
  clientsEmptyDescription: 'Vincula cada auditorÃ­a, documento y contrato a una empresa. Todo ordenado, siempre localizable.',
  clientsAdd: 'AÃ±adir cliente',
  clientsTypeClient: 'Cliente',
  clientsTypeCompany: 'Empresa',
  clientsTypeFreelancer: 'AutÃ³nomo',
  ...
  clientsTypeClientNamePlaceholder: 'Empresa, autÃ³nomo o persona',
  ...
  clientsTypePatientContactPlaceholder: 'Opcional, Ãºtil si es menor o dependiente',
  ...
  clientsTypeEventNamePlaceholder: 'Boda Laura y AndrÃ©s, sesiÃ³n familiar...',
  clientsTypeEventContactPlaceholder: 'QuiÃ©n coordina el evento',
  clientsContactHelp: 'Para autÃ³nomos o particulares puedes dejarlo vacÃ­o.',
  clientsPhone: 'TelÃ©fono',
  clientsFiscalDataTitle: 'Datos fiscales para facturas',
  clientsFiscalDataDescription: 'Se mostrarÃ¡n como datos del destinatario cuando emitas una factura a este cliente.',
  clientsCountry: 'PaÃ­s',
  clientsDefaultCountry: 'EspaÃ±a',
  clientsFiscalAddress: 'Domicilio fiscal',
  clientsFiscalAddressPlaceholder: 'Calle, nÃºmero, piso...',
  clientsPostalCode: 'CÃ³digo postal',
  clientsCity: 'Ciudad',
  clientsProvince: 'Provincia / regiÃ³n',
  clientsSector: 'Sector',
  clientsSectorPlaceholder: 'TecnologÃ­a, HostelerÃ­a...',
  clientsNotes: 'Notas',
  clientsNotesPlaceholder: 'InformaciÃ³n adicional...',
  ...
  clientsArchiveConfirm: 'Â¿Archivar este cliente? Se ocultarÃ¡ de la lista.',
  clientsArchiveConfirmPrefix: 'Â¿Archivar a "',
  clientsArchiveConfirmSuffix: '"? Se ocultarÃ¡ de la lista.',
  clientsSince: 'Desde',
  ...
  clientsExecutionSingular: 'ejecuciÃ³n',
  clientsExecutionPlural: 'ejecuciones',
  clientsLastPrefix: 'Ãšltima',
  clientsRun: 'Ejecutar',
  clientsHistory: 'Historial',
  clientsRecentExecutions: 'Ãšltimas ejecuciones',
  clientsDate: 'Fecha',
  ...
  clientsUser: 'Usuario',
  clientsView: 'Ver',
  clientsFilesDescription: 'Expediente documental vinculado a este cliente. TambiÃ©n queda guardado en Studio.',
  ...
  clientsFileUploadError: 'No se pudo subir el archivo. Comprueba el tamaÃ±o y formato, e intÃ©ntalo de nuevo.',
  clientsFolderCreateError: 'No se pudo crear la carpeta. IntÃ©ntalo de nuevo.',
  clientsNoFiles: 'No hay archivos vinculados a este cliente.',
  clientsDropFilesHelp: 'Arrastra aquÃ­ contratos, PDFs, imÃ¡genes o cualquier documento relacionado.',
  clientsFolderPrefix: 'Carpeta',
  clientsDownload: 'Descargar',
  clientsPortalCopied: 'Enlace copiado',
  clientsPortal: 'Portal del cliente',
  brainDescription: 'Consulta la memoria de tu workspace â€” documentos, objetivos, conversaciones y herramientas.',
  brainTabBrain: 'Brain',
  brainTabHistory: 'Historial',
  brainTabMemory: 'Memoria',
  brainTabLocal: 'Local',
  brainQuickWhatNow: 'Â¿QuÃ© hago ahora?',
  brainQuickWhatNowQuery: 'Â¿CuÃ¡les son las tareas y objetivos mÃ¡s urgentes actualmente?',
  ...
  brainSourceConversation: 'ConversaciÃ³n',
  ...
  brainQueryPlaceholder: 'Â¿QuÃ© quieres consultar?',
  brainQueryError: 'Error al consultar el Brain',
  brainConnectionError: 'Error de conexiÃ³n. IntÃ©ntalo de nuevo.',
  ...
  brainModeOrientation: 'OrientaciÃ³n',
  ...
  brainNoQueries: 'No hay consultas registradas todavÃ­a.',
  ...
  brainMemoryTypeDecision: 'DecisiÃ³n',
  brainMemoryTypeHypothesis: 'HipÃ³tesis',
  brainMemoryTypeContext: 'Contexto',
  brainMemoryLoadError: 'No se pudo cargar la memoria cloud. IntÃ©ntalo de nuevo.',
  brainMemoryOpenError: 'No se pudo abrir la memoria.',
  brainMemoryTitleRequired: 'El tÃ­tulo es obligatorio.',
  brainMemoryContentRequired: 'El contenido es obligatorio.',
  brainMemorySaveError: 'No se pudo guardar. IntÃ©ntalo de nuevo.',
  brainMemoryUpdateError: 'No se pudo actualizar. IntÃ©ntalo de nuevo.',
  brainMemoryArchiveError: 'No se pudo archivar. IntÃ©ntalo de nuevo.',
  brainMemoryRestoreError: 'No se pudo restaurar. IntÃ©ntalo de nuevo.',
  brainMemoryArchiveConfirmPrefix: 'Â¿Archivar "',
  brainMemoryArchiveConfirmSuffix: '"? DejarÃ¡ de aparecer en Brain, pero no se borrarÃ¡.',
  brainMemoryCloudNotice: 'Esta memoria se guarda en MITIKUS Cloud como fuente de verdad. Cuando el Core local estÃ¡ disponible, MITIKUS intenta indexarla tambiÃ©n como copia secundaria.',
  ...
  brainMemorySearchPlaceholder: 'Busca por tÃ­tulo o contenido',
  brainMemoryType: 'Tipo',
  brainMemoryAll: 'Todos',
  brainMemoryCount: 'memorias',
  brainMemoryClearFilters: 'Limpiar filtros',
  brainMemoryTitle: 'TÃ­tulo',
  brainMemoryTitlePlaceholder: 'p. ej. DecisiÃ³n sobre arquitectura de auth',
  brainMemoryContent: 'Contenido',
  brainMemoryContentPlaceholder: 'Escribe aquÃ­ el contenido de la memoria...',
  ...
  brainMemoryEmpty: 'No hay memoria cloud todavÃ­a.',
  brainMemoryTrySearch: 'Prueba con otra bÃºsqueda o limpia los filtros.',
  brainMemoryArchivedHint: 'Cuando archives una memoria, aparecerÃ¡ aquÃ­.',
  brainMemoryCreateFirst: 'Crea la primera con el botÃ³n de arriba.',
  ...
  brainLocalQuickCurrentState: 'Â¿En quÃ© estamos ahora?',
  brainLocalQuickCurrentStateQuery: 'CuÃ¡l es el estado actual y foco del proyecto',
  brainLocalQuickHypotheses: 'Â¿QuÃ© hipÃ³tesis tenemos?',
  brainLocalQuickHypothesesQuery: 'HipÃ³tesis y supuestos del proyecto',
  brainLocalQuickUserProfile: 'Â¿QuÃ© sabemos del usuario?',
  brainLocalQuickUserProfileQuery: 'Perfil de usuario cliente y problema que resuelve',
  brainLocalQuickPendingDecisions: 'Â¿QuÃ© decisiones estÃ¡n pendientes?',
  brainLocalQuickPendingDecisionsQuery: 'Decisiones pendientes y dudas sin resolver',
  brainLocalSetupDescription: 'MITIKUS sigue funcionando con Brain, memoria cloud, historial y datos del workspace. Activa el Core solo si quieres aÃ±adir una capa privada en este ordenador.',
  ...
  brainLocalRetry: 'Reintentar conexiÃ³n',
  brainLocalAddBaseMemory: 'AÃ±adir memoria base',
  brainLocalBaseMemoryDescription: 'Pega aquÃ­ contexto privado para este ordenador. La memoria principal del producto estÃ¡ en la pestaÃ±a Memoria.',
  brainLocalTitlePlaceholder: 'Memoria base â€” tema del proyecto',
  brainLocalContentPlaceholder: 'QuÃ© es el proyecto, objetivo actual, usuarios posibles, dudas, decisiones y prÃ³ximos pasos.',
  brainLocalQuestionPlaceholder: 'Â¿QuÃ© necesitas saber ahora?',
  ...
  officeFilesDescription: 'Organiza documentos, imÃ¡genes y hojas de cÃ¡lculo en carpetas',
  officeFilesRoot: 'RaÃ­z',
  ...
  officeFilesLimitReached: 'LÃ­mite alcanzado',
  officeFilesAlmostFull: 'Casi lleno',
  officeFilesUpgradeStorage: 'AmplÃ­a tu almacenamiento â€” â‚¬2/GB/mes',
  officeFilesAddStorage: 'AÃ±adir almacenamiento',
  officeFilesProcessing: 'Procesando...',
  officeFilesPurchaseError: 'Error al procesar la compra.',
  officeFilesNetworkError: 'Error de red. IntÃ©ntalo de nuevo.',
  officeFilesDeleteConfirm: 'Â¿Eliminar este archivo? Esta acciÃ³n no se puede deshacer.',
  officeFilesEmpty: 'Sin archivos en esta ubicaciÃ³n',
  ...
  officeFilesUploadHelp: 'PDF, DOCX, XLSX, imÃ¡genes, TXT, MD, JSON, ZIP â€” mÃ¡x. 50 MB',
  ...
  officeFilesMoveHere: 'Mover aquÃ­',
  ...
  contractsConnectionError: 'Error de conexiÃ³n. IntÃ©ntalo de nuevo.',
  ...
  contractsEmptyDescription: 'Arrastra un PDF arriba o usa el botÃ³n de carga. El cliente puede firmarlo digitalmente con verificaciÃ³n OTP.',
  ...
  contractsSaveSignatureError: 'Error al guardar la firma. IntÃ©ntalo de nuevo.',
  contractsSendError: 'Error al enviar al cliente. IntÃ©ntalo de nuevo.',
  contractsYourSignature: 'Tu firma',
  contractsSavingSignature: 'Guardando firma...',
  contractsAcceptTerms: 'Acepto los tÃ©rminos',
  contractsSignedOn: 'Firmado el',
  contractsClientSignature: 'Firma cliente',
  contractsPendingSend: 'Pendiente de envÃ­o',
  contractsSentToPrefix: 'Enviado a',
  contractsPendingSignature: 'pendiente de firma',
  contractsClientName: 'Nombre del cliente',
  contractsClientNamePlaceholder: 'Juan GarcÃ­a',
  contractsClientEmail: 'Email del cliente',
  contractsSending: 'Enviando...',
  contractsSend: 'Enviar',
  // Leads
  leadsTitle: 'Leads',
  leadsSubtitle: 'Potenciales clientes â€” captados desde tu formulario pÃºblico.',
  leadsAll: 'Todos',
  leadsNoLeads: 'AÃºn no tienes leads',
  ...
  leadsConvertConfirmPrefix: 'Â¿Convertir a ',
  leadsConvertConfirmSuffix: ' en cliente?',
  leadsDeleteConfirmPrefix: 'Â¿Eliminar el lead de ',
  leadsDeleteConfirmSuffix: '?',
  ...
  historyEmpty: 'Sin historial todavÃ­a',
  historyEmptyDescription: 'Las ejecuciones IA de tus herramientas aparecerÃ¡n aquÃ­.',
  ...
  historyTokens: 'Tokens',
  historyCost: 'Coste',
  historyDuration: 'DuraciÃ³n',
  historyUser: 'Usuario',
  historyActions: 'Acciones',
  historyRerun: 'â†» Reejecutar',
  historyView: 'Ver',
  historyRetry: 'â†» Reintentar',
  historyFooterSingular: 'ejecuciÃ³n',
  ...
  analyticsSuccessRate: 'Tasa de Ã©xito',
  ...
  analyticsAvgTimeMicro: 'Por ejecuciÃ³n de herramienta',
  analyticsAvgCostMicro: 'Por ejecuciÃ³n',
  analyticsCostByDayTitle: 'Coste IA por dÃ­a',
  analyticsCostByMonthTitle: 'Coste IA por mes',
  analyticsExecutionStatus: 'Estado de ejecuciones',
  analyticsTopTools: 'Herramientas mÃ¡s usadas',
  analyticsProviderBreakdown: 'DistribuciÃ³n por proveedor',
  analyticsAiModels: 'Modelos IA',
  analyticsWorkflowsExecuted: 'Flujos ejecutados',
  analyticsExecutionsByDayTitle: 'Ejecuciones por dÃ­a',
  ...
  analyticsAdminOnly: 'Solo los administradores del workspace pueden ver la analÃ­tica.',
  analyticsTotalLabel: 'Total:',
  ...
  // Office
  officeTitle: 'Studio',
  officeSubtitle: 'Tus herramientas de documento y gestiÃ³n',
  officeDocumentsSection: 'Documentos',
  officeFiscalSection: 'Fiscal (EspaÃ±a)',
  officeQuarterly: 'Trimestral',
  officeAnnual: 'Anual',
  officeSeeCalendar: 'Ver calendario â†’',
  officeTaxVatQuarterly: 'IVA trimestral',
  officeTaxIrpfInstallments: 'IRPF fraccionado (autÃ³nomos)',
  ...
  officeTaxIncomeReturn: 'Renta (IRPF autÃ³nomos)',
  ...
  officeToolContractsSubtitle: 'Firma electrÃ³nica',
  officeToolInvoices: 'Facturas',
  officeToolInvoicesSubtitle: 'PDF descargable',
  officeToolSheets: 'Hojas de cÃ¡lculo',
  officeToolSheetsSubtitle: 'Datos y presupuestos',
  officeToolPdfs: 'PDFs',
  officeToolPdfsSubtitle: 'Visor y bÃºsqueda',
  ...
  officeToolReceiptsSubtitle: 'OCR por cÃ¡mara',
  officeToolFiles: 'Archivos',
  officeToolFilesSubtitle: 'Carpetas y ficheros',
  // Audit
  auditTitle: 'AuditorÃ­a',
  auditSubtitlePrefix: 'Rastro de auditorÃ­a Â· ',
  ...
  auditPageLabel: 'PÃ¡gina ',
  auditPageOf: ' de ',
  auditPrev: 'â† Anterior',
  auditNext: 'Siguiente â†’',
  auditAccessRestricted: 'Acceso restringido',
  auditAdminOnly: 'Solo los administradores del workspace pueden ver el registro de auditorÃ­a.',
  // Dashboard home
  dashboardSinceLastVisit: 'Desde tu Ãºltima visita, {name}:',
  // Workflows
  workflowsTitle: 'Flujos',
  workflowsSubtitle: 'Cadenas de herramientas inteligentes',
  workflowsNew: '+ Nuevo flujo',
  workflowsHowItWorksTitle: 'Â¿CÃ³mo funciona un flujo?',
  workflowsStep1Title: 'Elige las herramientas',
  workflowsStep1Description: 'Combina cualquier herramienta instalada en tu workspace: analizadores, generadores, extractores de datosâ€¦',
  workflowsStep2Title: 'Conecta los pasos',
  workflowsStep2Description: 'El resultado de cada herramienta pasa automÃ¡ticamente como entrada a la siguiente. Sin copiar ni pegar.',
  workflowsStep3Title: 'EjecÃºtalo en un clic',
  workflowsStep3Description: 'Introduce el dato inicial y el flujo hace el resto. Revisa el historial de cada ejecuciÃ³n cuando quieras.',
  ...
  workflowsLastRun: 'Ãšltima ejecuciÃ³n',
  workflowsActiveTitle: 'Activo',
  workflowsInactiveTitle: 'Inactivo',
  // Home/workspace page
  homePanelSubtitle: 'Panel â€” quÃ© es lo mÃ¡s importante que debes hacer hoy',
  homeMissionsTitle: 'Misiones activas',
  homeCreateMission: 'Crear misiÃ³n â†’',
  ...
  homeResolveBlocker: 'Resolver bloqueo â†’',
  homeNoMissions: 'No hay misiones activas.',
  homeNoMissionsDesc: 'CuÃ©ntale a Arkos un objetivo de tu empresa y lo convertirÃ¡ en una misiÃ³n con pasos claros, o usa una plantilla para empezar al instante.',
  homeDefineWithArkos: 'Definir con Arkos â†’',
  homePriorityCritical: 'CrÃ­tica',
  ...
  homeNowLabel: 'Ahora',
  homeWhyFirstLabel: 'Â¿Por quÃ© primero?',
  homeWillUnlock: 'DesbloquearÃ¡:',
  homeTimeLabel: 'Tiempo:',
  homeStepsProgressSingular: 'paso',
  homeStepsProgressPlural: 'pasos',
  homeContinueMission: 'Continuar misiÃ³n â†’',
  homeNowColon: 'Ahora:',
  // TrialBanner
  trialUrgentPrefix: 'âš ï¸ Tu periodo de prueba termina en ',
  trialDaySingular: ' dÃ­a',
  trialDayPlural: ' dÃ­as',
  trialUrgentSuffix: '. No perderÃ¡s nada si activas tu plan ahora.',
  trialNormalPrefix: 'Periodo de prueba Â· ',
  trialNormalSingularSuffix: ' dÃ­a restante',
  trialNormalPluralSuffix: ' dÃ­as restantes',
  trialActivate: 'Activar plan â†’',
  // LastExecutionWidget
  lastExecEmpty: 'AÃºn no has ejecutado ninguna herramienta.',
  lastExecSeeTools: 'Ver herramientas â†’',
  lastExecLabel: 'Ãšltima ejecuciÃ³n',
  ...
  lastExecRerun: 'Ejecutar de nuevo â†’',
  // MissionTemplateModal
  templateFromTemplate: 'Desde plantilla',
  templateModalTitle: 'Plantillas de misiÃ³n',
  templateModalSubtitle: 'Elige una para empezar con los pasos ya definidos.',
  templateSteps: 'pasos',
  templateBackToList: 'â† Volver a plantillas',
  templateIncludedStepsPrefix: 'Pasos incluidos (',
  templateActorAI: 'âœ¨ IA',
  templateActorShared: 'ðŸ¤ Compartido',
  templateActorUser: 'ðŸ‘¤ TÃº',
  templateMinutes: 'min',
  templateError: 'No se pudo crear la misiÃ³n. IntÃ©ntalo de nuevo.',
  templateBack: 'AtrÃ¡s',
  templateCreating: 'Creando...',
  templateCreate: 'Crear misiÃ³n',
  // GlobalSearch
  searchLabel: 'Buscar',
  searchGlobalLabel: 'BÃºsqueda global',
  searchPlaceholder: 'Busca entre documentos, clientes, contratosâ€¦',
  ...
  searchTypeSheet: 'Hoja de cÃ¡lculo',
  searchTypePresentation: 'PresentaciÃ³n',
  searchTypeTask: 'Tarea',
  searchTypeMission: 'MisiÃ³n',
  ...
  searchMinChars: 'Escribe al menos 2 caracteres Â· Busca entre documentos, PDFs, contratos, hojas, presentaciones, tareas, misiones, clientes y herramientas',
  ...
  searchNav: 'â†‘â†“ navegar',
  searchOpen: 'â†µ abrir',
  searchClose: 'Esc cerrar',
  searchResultsSuffix: 'resultado',
  searchRelativeToday: 'hoy',
  searchRelativeYesterday: 'ayer',
  searchRelativeDaysAgo: 'd atrÃ¡s',
  searchRelativeWeeks: 'sem atrÃ¡s',
  searchRelativeMonths: 'mes atrÃ¡s',
  // TaskList
  tasksTitle: 'Tareas',
  ...
  analyticsEmptyHint: 'Ejecuta herramientas o workflows para ver mÃ©tricas aquÃ­.',
  ...
  invoicesEmpty: 'No hay facturas todavÃ­a',
  ...
  invoicesRectDesc: 'Se crearÃ¡ una factura rectificativa (tipo R1) en borrador referenciando la factura',
  invoicesRectAmountsCopied: 'Los importes se copiarÃ¡n en negativo para que los revises.',
  invoicesRectReason: 'Motivo de la rectificaciÃ³n',
  invoicesRectPlaceholder: 'Ej: Error en importe, devoluciÃ³n parcial de servicioâ€¦',
  invoicesRectCancel: 'Cancelar',
  invoicesRectCreate: 'Crear rectificativa',
  invoicesRectCreating: 'Creandoâ€¦',
  invoicesRectError: 'No se pudo crear la factura rectificativa. IntÃ©ntalo de nuevo.',
  invoicesRectReasonRequired: 'Indica el motivo de la rectificaciÃ³n',
  ...
  invoicesSendNote: 'MITIKUS enviarÃ¡ la factura {number} usando la identidad de correo configurada. Si el envÃ­o falla, la factura no se marcarÃ¡ como enviada.',
  invoicesSendClose: 'Cerrar',
  invoicesSendCancel: 'Cancelar',
  invoicesSendButton: 'Enviar factura',
  invoicesSending: 'Enviandoâ€¦',
  invoicesSentOk: 'âœ“ Factura enviada correctamente.',
  invoicesSendError: 'No se pudo enviar la factura. Comprueba que tienes correo configurado en Ajustes â†’ Correo y envÃ­os.',
  invoicesSendErrorSettings: 'Ajustes â†’ Correo y envÃ­os',
  invoicesSendCheckSettings: 'Revisa la configuraciÃ³n de correo en',
  invoicesNoReplies: 'Sin respuestas nuevas por ahora.',
  invoicesRepliesError: 'No se han podido revisar las respuestas del buzÃ³n.',
  invoicesDeleteConfirm: 'Â¿Eliminar factura {number}?',
  invoicesSuffix: 'factura',
  // Workspace settings page
  wsSettingsTitle: 'Ajustes del workspace',
  wsSettingsSubtitle: 'Personaliza marca, datos visibles y envÃ­os de tu espacio de trabajo.',
  ...
  integrationsEmailDescription: 'EnvÃ­a y recibe correos de clientes con MITIKUS, Gmail, Outlook o tu propia cuenta SMTP/IMAP.',
  integrationsCalendarTitle: 'Calendario',
  integrationsCalendarDescription: 'Prepara Google Calendar u Outlook Calendar para llamadas, vencimientos, recordatorios y planificaciÃ³n de misiones.',
  integrationsGoogleCalendar: 'Google Calendar',
  integrationsOutlookCalendar: 'Outlook Calendar',
  ...
  integrationsCalendarConnectError: 'No se pudo iniciar la conexiÃ³n del calendario.',
  ...
  integrationsStorageConnectError: 'No se pudo iniciar la conexiÃ³n de almacenamiento.',
  ...
  integrationsSignaturit: 'Signaturit',
  integrationsDocuSign: 'DocuSign',
  integrationsCommunicationTitle: 'ComunicaciÃ³n',
  integrationsCommunicationDescription: 'Prepara mensajerÃ­a con clientes para seguimiento de leads, recordatorios de facturas y avisos de flujos.',
  integrationsWhatsAppBusiness: 'WhatsApp Business',
  integrationsTwilio: 'Twilio',
  integrationsFormsTitle: 'Formularios y captaciÃ³n',
  ...
  integrationsVideoCallsDescription: 'Prepara enlaces de reuniÃ³n online para clientes, misiones, contratos y seguimientos programados.',
  integrationsGoogleMeet: 'Google Meet',
  integrationsMicrosoftTeams: 'Microsoft Teams',
  integrationsZoom: 'Zoom',
  integrationsAutomationTitle: 'Automatizaciones externas',
  integrationsAutomationDescription: 'Prepara conexiones con Make, Zapier y n8n para que los flujos de MITIKUS puedan disparar procesos externos mÃ¡s adelante.',
  integrationsMake: 'Make',
  integrationsZapier: 'Zapier',
  integrationsN8n: 'n8n',
  integrationsAccountingTitle: 'Contabilidad',
  integrationsAccountingDescription: 'Prepara exportaciones y futura sincronizaciÃ³n con herramientas contables usadas por autÃ³nomos, agencias y pymes.',
  integrationsHolded: 'Holded',
  integrationsSage: 'Sage',
  integrationsQuipu: 'Quipu',
  integrationsAnfix: 'Anfix',
  ...
  integrationsPaypal: 'PayPal',
  integrationsRedsys: 'Redsys',
  integrationsComingSoon: 'PrÃ³ximamente',
  ...
  wsLogoFont: 'Fuente',
  wsEmailSection: 'Correo y envÃ­os',
  wsEmailDesc: 'Elige cÃ³mo salen los correos desde este workspace.',
  wsEmailMitikusLabel: 'MITIKUS',
  wsEmailMitikusDesc: 'MITIKUS envÃ­a por ti. Las respuestas llegan al email que indiques.',
  wsEmailSmtpLabel: 'SMTP propio',
  wsEmailSmtpDesc: 'Hosting, webmail o correo corporativo.',
  wsEmailGmailLabel: 'Gmail',
  wsEmailGmailDesc: 'Usa smtp.gmail.com con contraseÃ±a de aplicaciÃ³n.',
  wsEmailOutlookLabel: 'Outlook / Microsoft 365',
  wsEmailOutlookDesc: 'Usa Microsoft 365 con SMTP AUTH activo.',
  wsEmailGmailHelp: 'Gmail necesita una contraseÃ±a de aplicaciÃ³n de Google. No uses tu contraseÃ±a normal si tienes doble factor.',
  wsEmailOutlookHelp: 'Outlook y Microsoft 365 pueden requerir activar SMTP AUTH o usar una contraseÃ±a de aplicaciÃ³n.',
  wsEmailCustomHelp: 'Usa los datos de configuraciÃ³n manual de tu hosting: servidor SMTP, puerto, usuario y contraseÃ±a.',
  wsEmailMitikusHelp: 'Las respuestas llegarÃ¡n al email indicado. La entrega real se gestiona desde la infraestructura de MITIKUS.',
  ...
  wsSmtpTitle: 'ConfiguraciÃ³n SMTP (salida)',
  wsSmtpServer: 'Servidor SMTP',
  wsSmtpPort: 'Puerto',
  wsSmtpUser: 'Usuario / email',
  wsSmtpPassword: 'ContraseÃ±a',
  wsSmtpPasswordPlaceholder: 'DÃ©jalo vacÃ­o para no cambiarla',
  wsSmtpTls: 'Usar TLS directo (puerto 465)',
  wsImapTitle: 'ConfiguraciÃ³n IMAP (bandeja de entrada)',
  wsImapServer: 'Servidor IMAP',
  wsImapPort: 'Puerto IMAP',
  wsImapUser: 'Usuario IMAP',
  wsImapPassword: 'ContraseÃ±a IMAP',
  wsImapPasswordPlaceholder: 'VacÃ­o si es la misma que SMTP',
  wsImapTls: 'Usar TLS (IMAPS, recomendado)',
  wsImapNote: 'Las contraseÃ±as se cifran antes de guardarse. Si salida y entrada usan el mismo email, puedes dejar la contraseÃ±a IMAP vacÃ­a.',
  wsEmailConnectionOk: 'ConexiÃ³n de correo correcta. Ya puedes guardar esta configuraciÃ³n.',
  wsEmailTest: 'Probar conexiÃ³n',
  wsEmailTesting: 'Probandoâ€¦',
  wsEmailTestOk: 'âœ“ ConexiÃ³n correcta',
  wsEmailSave: 'Guardar correo',
  wsEmailSaving: 'Guardandoâ€¦',
  wsEmailSaved: 'âœ“ Guardado',
  wsEmailSaveError: 'No se han podido guardar los ajustes de correo. Revisa los datos e intÃ©ntalo de nuevo.',
  wsEmailTestError: 'No se ha podido probar la conexiÃ³n SMTP. Comprueba el servidor y el puerto.',
  wsNameSection: 'Nombre del workspace',
  wsNameDesc: 'Visible en la barra lateral y en los correos de invitaciÃ³n.',
  ...
  wsPermSection: 'Permisos de creaciÃ³n',
  wsPermDesc: 'Controla quiÃ©n puede instalar herramientas y crear misiones en este workspace.',
  wsPermOnlyAdmins: 'Solo Admins y Owners pueden crear',
  wsPermOnlyAdminsActive: 'Activo â€” Editores y rangos inferiores no pueden instalar herramientas ni crear misiones.',
  wsPermOnlyAdminsInactive: 'Desactivado â€” Todos los Editores pueden instalar herramientas y crear misiones.',
  wsPermOwnerOnly: 'Solo el Owner del workspace puede cambiar este ajuste.',
  wsPermSaved: 'âœ“ Guardado',
  wsSave: 'Guardar cambios',
  wsSaving: 'Guardandoâ€¦',
  wsSaved: 'âœ“ Guardado',
  // Receipts page
  receiptsOffice: 'Studio',
  receiptsTitle: 'Gastos',
  receiptsSubtitle: 'Escanea tickets y facturas â€” la IA extrae los datos automÃ¡ticamente',
  // ReceiptsClient
  ...
  receiptsScanNow: 'Escanear ahora â†’',
  ...
  receiptsTax: 'IVA',
  receiptsCategory: 'CategorÃ­a',
  receiptsNotes: 'Notas',
  receiptsStatus: 'Estado',
  receiptsLines: 'LÃ­neas',
  // Receipts scan modal
  receiptsScanTitle: 'Escanear ticket / factura',
  receiptsScanSubtitle: 'La IA extrae automÃ¡ticamente los datos de tu ticket o factura.',
  receiptsScanAnalyzing: 'Analizando imagen con IAâ€¦',
  receiptsScanAnalyzingHint: 'Esto puede tardar unos segundos.',
  receiptsScanUploadHint: 'Sube una foto de tu ticket o factura',
  receiptsScanFormats: 'JPG, PNG, WEBP â€” mÃ¡x. 10 MB',
  receiptsScanSelectBtn: 'Seleccionar imagen',
  receiptsScanDropHint: 'o arrastra aquÃ­',
  receiptsScanError: 'No se pudo analizar la imagen. IntÃ©ntalo de nuevo.',
  receiptsScanSaveError: 'Error al guardar el gasto.',
  receiptsScanExtracted: 'Datos extraÃ­dos â€” revisa y corrige si es necesario',
  ...
  receiptsScanCategoryLabel: 'CategorÃ­a',
  receiptsScanNoCategory: 'Sin categorÃ­a',
  receiptsScanStatusLabel: 'Estado',
  receiptsScanNotesLabel: 'Notas',
  receiptsScanNotesPlaceholder: 'Notas adicionalesâ€¦',
  receiptsScanThumbnailAlt: 'Miniatura del ticket',
  receiptsScanLineItems: 'LÃ­neas del ticket',
  receiptsScanColDescription: 'DescripciÃ³n',
  ...
  profileAvatarHint: 'Aparece en la barra de navegaciÃ³n y junto a tus actividades.',
  profileAvatarSaved: 'âœ“ Foto actualizada',
  profileInfoSection: 'InformaciÃ³n',
  profileName: 'Nombre y apellidos',
  profileEmail: 'Email',
  profileJobTitle: 'Cargo',
  profileJobTitlePlaceholder: 'Ej. CEO, DiseÃ±adora, Freelanceâ€¦',
  profileSave: 'Guardar',
  profileSaving: 'Guardandoâ€¦',
  profileSaved: 'âœ“ Guardado',
  profileRole: 'Rol en el workspace',
  profileRoleMember: 'Miembro',
  profileRoleViewer: 'Visualizador',
  // Workflows
  wfNewTitle: 'Nuevo Workflow',
  wfNewDesc: 'Define un nombre y descripciÃ³n. AÃ±adirÃ¡s los pasos en el editor de canvas.',
  wfNameLabel: 'Nombre del workflow *',
  wfNamePlaceholder: 'ej. AnÃ¡lisis estratÃ©gico completo',
  wfDescLabel: 'DescripciÃ³n',
  wfDescOptional: '(opcional)',
  wfDescPlaceholder: 'ej. DAFO â†’ AnÃ¡lisis competencia â†’ Plan de acciÃ³n â†’ Informe ejecutivo',
  wfCreate: 'Crear y abrir editor â†’',
  wfCreating: 'Creandoâ€¦',
  wfGenerateTitle: 'Generar',
  wfGenerateDesc: 'Describe tu proceso en lenguaje natural y la IA crea el workflow automÃ¡ticamente, eligiendo y conectando las herramientas por ti.',
  wfGenerate: 'âœ¨ Generar',
  // Usage page
  ...
  usageUsers: 'Usuarios',
  usageWorkspaces: 'Workspaces',
  usageReuseSection: 'ReutilizaciÃ³n',
  usageCatalogSearches: 'BÃºsquedas en catÃ¡logo',
  usageToolsReused: 'Herramientas reutilizadas',
  usageGenerations: 'Generaciones',
  usageReuseRate: 'Tasa de reutilizaciÃ³n',
  usageReuseRateDesc: '{reused} de {total} bÃºsquedas resultaron en instalaciÃ³n o fork en lugar de generar una nueva.',
  usageStorageSection: 'Almacenamiento',
  usageStorageLabel: 'Archivos en este workspace',
  usageStorageFiles: 'archivos almacenados',
  usageManageFiles: 'Gestionar archivos â†’',
  ...
  usageViewContracts: 'Ver contratos â†’',
  usageViewInvoices: 'Ver facturas â†’',
  usageUpgradeCta: 'Activa un plan para eliminar los lÃ­mites',
  usageUpgradeDesc: 'MÃ¡s generaciones IA, mÃ¡s almacenamiento, mÃ¡s usuarios y acceso al Brain.',
  usageViewPlans: 'Ver planes â†’',
  ...
  usageDailyLimits: 'LÃ­mites diarios',
  usageLimitUser: 'Usuario (tÃº)',
  usageLimitWorkspace: 'Workspace',
  usageLimitSystem: 'Sistema (global)',
  usageLimitCost: 'Coste estimado (global)',
  usageLimitsReset: 'Los lÃ­mites se reinician automÃ¡ticamente a las 00:00 UTC.',
  usageRemainingText: 'Puedes generar {personal} herramientas mÃ¡s hoy (lÃ­mite personal) y {workspace} en este workspace.',
  usageDailyRunsToday: 'Ejecuciones hoy',
  usageDailyRunsMonth: 'Ejecuciones este mes',
  // Team management
  teamSectionTitle: 'Equipo',
  teamSectionSubtitle: 'Gestiona los miembros de tu organizaciÃ³n e invita a nuevas personas.',
  ...
  teamInvitePlaceholder: 'Email (opcional â€” si lo dejas vacÃ­o se genera un enlace)',
  teamExpired: 'âš  Caducada',
  teamExpires: 'Caduca',
  teamOpenLink: 'Enlace abierto',
  teamLoading: 'Cargandoâ€¦',
  teamConfirmRemove: 'Â¿Eliminar este miembro del equipo?',
  teamInviteError: 'Error al crear invitaciÃ³n',
  teamConnError: 'Error de conexiÃ³n',
  teamInviting: 'â€¦',
}
...
const fr: DashboardTranslations = {
  ...
  navIntegrations: 'IntÃ©grations',
  groupWork: 'Travail',
  groupContent: 'Contenu',
  groupSystem: 'SystÃ¨me',
  descToday: 'Vos tÃ¢ches en attente et l\'activitÃ© de l\'Ã©quipe aujourd\'hui',
  descCopilot: 'Votre conseiller stratÃ©gique â€” partagez vos objectifs et il vous aide Ã  les planifier',
  descBrain: 'Interrogez la mÃ©moire du workspace â€” documents, objectifs et dÃ©cisions',
  descMail: 'BoÃ®te de rÃ©ception, envoyÃ©s, brouillons et e-mails clients',
  descClients: 'Les entreprises ou personnes auxquelles vous fournissez des services',
  descLeads: 'Clients potentiels capturÃ©s depuis votre formulaire public',
  descTasks: 'TÃ¢ches d\'Ã©quipe avec Ã©tiquetage collaboratif',
  descTools: 'Les outils que vous avez installÃ©s ou crÃ©Ã©s pour votre activitÃ©',
  descWorkflows: 'EnchaÃ®nez plusieurs outils pour automatiser un processus complet',
  descOffice: 'Documents, tableurs, PDFs, contrats et prÃ©sentations',
  descFiles: 'Stockage de fichiers du workspace avec export ZIP',
  descMissions: 'Objectifs stratÃ©giques et leurs Ã©tapes d\'exÃ©cution',
  descFiscal: 'Calendrier des obligations fiscales de votre entreprise',
  descInvoices: 'CrÃ©ez et gÃ©rez des factures pour vos clients avec PDF tÃ©lÃ©chargeable',
  descReceipts: 'Scannez tickets et factures avec la camÃ©ra â€” l\'IA extrait les donnÃ©es',
  descAnalytics: 'ActivitÃ©, exÃ©cutions et coÃ»ts de votre workspace',
  descUsage: 'Combien vous avez gÃ©nÃ©rÃ© ce mois et combien il reste de votre plan',
  ...
  descProfile: 'Votre photo de profil et prÃ©fÃ©rences personnelles',
  descSupport: 'Assistant d\'aide et contact avec l\'Ã©quipe MITIKUS',
  descSettings: 'Logo, couleur de marque et nom du workspace',
  descIntegrations: 'Connectez des apps et services externes Ã  ce workspace',
  newMission: 'Nouvelle mission',
  expandSidebar: 'Agrandir la barre latÃ©rale',
  collapseSidebar: 'RÃ©duire la barre latÃ©rale',
  openMenu: 'Ouvrir le menu',
  closeTeamPanel: 'Fermer le panneau Ã©quipe',
  openTeamPanel: 'Ouvrir le panneau Ã©quipe',
  ...
  sectionTeam: 'Ã‰quipe',
  sectionSettings: 'ParamÃ¨tres',
  sectionIntegrations: 'IntÃ©grations',
  sectionGenerate: 'CrÃ©er un outil',
  sectionImport: 'Importer',
  sectionCopilot: 'Arkos',
  sectionBrain: 'Brain',
  sectionTasks: 'TÃ¢ches',
  ...
  sectionPresentations: 'PrÃ©sentations',
  sectionNotebooks: 'Carnets',
  sectionOffice: 'Mon Bureau',
  sectionHistory: 'Historique',
  sectionInvoices: 'Factures',
  sectionReceipts: 'DÃ©penses',
  subHistory: 'Historique',
  subRun: 'ExÃ©cuter',
  subSettings: 'ParamÃ¨tres',
  subRecords: 'Enregistrements',
  subChecklist: 'Checklist',
  subScoring: 'Score',
  subEdit: 'Modifier',
  subNew: 'Nouveau',
  bannerEarlyAccess: 'AccÃ¨s anticipÃ©',
  bannerCta: 'Places limitÃ©es Â· Rejoignez maintenant et bloquez votre prix de lancement',
  integrationsTitle: 'IntÃ©grations',
  ...
  integrationsCalendarDescription: 'PrÃ©parez Google Calendar ou Outlook Calendar pour les appels, Ã©chÃ©ances, rappels et la planification des missions.',
  integrationsGoogleCalendar: 'Google Calendar',
  integrationsOutlookCalendar: 'Outlook Calendar',
  integrationsConnectProvider: 'Connecter le compte',
  integrationsConnecting: 'Connexion...',
  integrationsDisconnect: 'DÃ©connecter',
  integrationsDisconnecting: 'DÃ©connexion...',
  integrationsCalendarConnectedAccount: 'Compte de calendrier connectÃ©',
  integrationsCalendarConnectError: 'Impossible de dÃ©marrer la connexion au calendrier.',
  integrationsCalendarDisconnectError: 'Impossible de dÃ©connecter le calendrier.',
  integrationsStorageTitle: 'Stockage',
  integrationsStorageDescription: 'PrÃ©parez le stockage externe pour documents, contrats, PDFs et sauvegardes du workspace.',
  integrationsGoogleDrive: 'Google Drive',
  integrationsOneDrive: 'OneDrive',
  integrationsDropbox: 'Dropbox',
  integrationsStorageConnectedAccount: 'Compte de stockage connectÃ©',
  integrationsStorageConnectError: 'Impossible de dÃ©marrer la connexion au stockage.',
  integrationsStorageDisconnectError: 'Impossible de dÃ©connecter le compte de stockage.',
  integrationsStorageExportFiles: 'Enregistrer le ZIP des fichiers',
  integrationsStorageExporting: 'Enregistrement...',
  integrationsStorageExported: 'ZIP des fichiers enregistrÃ© dans le stockage connectÃ©.',
  integrationsStorageOpenExport: 'Ouvrir',
  integrationsStorageExportError: 'Impossible dâ€™enregistrer le ZIP des fichiers dans le stockage connectÃ©.',
  integrationsAiTitle: 'Fournisseurs IA',
  integrationsAiDescription: 'Utilisez lâ€™IA gÃ©rÃ©e par MITIKUS par dÃ©faut et prÃ©parez les clÃ©s propres pour les plans avancÃ©s.',
  integrationsMitikusAi: 'MITIKUS IA',
  integrationsOpenAi: 'OpenAI',
  integrationsAnthropic: 'Anthropic',
  integrationsGemini: 'Google Gemini',
  integrationsManagedByMitikus: 'GÃ©rÃ© par MITIKUS',
  integrationsAiOwnKeyConfigured: 'ClÃ© API propre configurÃ©e',
  integrationsAiKeyLabel: 'ClÃ© API',
  integrationsAiKeyPlaceholder: 'Collez la clÃ© API du fournisseur',
  integrationsAiLabelLabel: 'LibellÃ© interne',
  integrationsAiLabelPlaceholder: 'Exemple : clÃ© OpenAI agence',
  integrationsAiSecurityNote: 'La clÃ© est chiffrÃ©e avant dâ€™Ãªtre enregistrÃ©e.',
  integrationsAiSave: 'Enregistrer le fournisseur',
  integrationsAiSaving: 'Enregistrement...',
  integrationsAiSaved: 'Fournisseur IA enregistrÃ©.',
  integrationsAiSaveError: 'Impossible dâ€™enregistrer le fournisseur IA.',
  integrationsAiDisconnectError: 'Impossible de dÃ©connecter le fournisseur IA.',
  integrationsSignatureTitle: 'Signature numÃ©rique',
  integrationsSignatureDescription: 'Utilisez la signature OTP MITIKUS par dÃ©faut et prÃ©parez des fournisseurs externes pour les contrats avancÃ©s.',
  integrationsMitikusSignature: 'Signature MITIKUS',
  integrationsSignaturit: 'Signaturit',
  integrationsDocuSign: 'DocuSign',
  integrationsCommunicationTitle: 'Communication',
  integrationsCommunicationDescription: 'PrÃ©parez la messagerie client pour le suivi des leads, les rappels de factures et les notifications de flux.',
  integrationsWhatsAppBusiness: 'WhatsApp Business',
  integrationsTwilio: 'Twilio',
  integrationsFormsTitle: 'Formulaires et acquisition',
  integrationsFormsDescription: 'PrÃ©parez des formulaires externes pour que les rÃ©ponses puissent crÃ©er des leads, clients, tÃ¢ches, contrats ou missions dans MITIKUS.',
  integrationsTypeform: 'Typeform',
  integrationsGoogleForms: 'Google Forms',
  integrationsTally: 'Tally',
  integrationsJotform: 'Jotform',
  ...
  integrationsFormsActionError: 'Could not update the forms integration.',
  integrationsFormsWebhookActive: 'Webhook active',
  integrationsVideoCallsTitle: 'Appels vidÃ©o',
  integrationsVideoCallsDescription: 'PrÃ©parez des liens de rÃ©union en ligne pour clients, missions, contrats et suivis planifiÃ©s.',
  integrationsGoogleMeet: 'Google Meet',
  integrationsMicrosoftTeams: 'Microsoft Teams',
  integrationsZoom: 'Zoom',
  integrationsAutomationTitle: 'Automatisations externes',
  integrationsAutomationDescription: 'PrÃ©parez les connexions Make, Zapier et n8n pour que les flux MITIKUS puissent dÃ©clencher des processus externes plus tard.',
  integrationsMake: 'Make',
  integrationsZapier: 'Zapier',
  integrationsN8n: 'n8n',
  integrationsAccountingTitle: 'ComptabilitÃ©',
  integrationsAccountingDescription: 'PrÃ©parez les exports et la future synchronisation avec les outils comptables utilisÃ©s par indÃ©pendants, agences et PME.',
  integrationsHolded: 'Holded',
  integrationsSage: 'Sage',
  integrationsQuipu: 'Quipu',
  integrationsAnfix: 'Anfix',
  integrationsContasimple: 'Contasimple',
  integrationsEcommerceTitle: 'E-commerce',
  integrationsEcommerceDescription: 'PrÃ©parez des connexions avec les boutiques en ligne pour importer clients, commandes, produits et ventes prÃªtes Ã  facturer.',
  integrationsShopify: 'Shopify',
  integrationsWooCommerce: 'WooCommerce',
  integrationsPrestashop: 'Prestashop',
  integrationsPaymentsTitle: 'Paiement des factures',
  integrationsPaymentsDescription: 'PrÃ©parez de futurs liens de paiement pour que les clients puissent payer les factures Ã©mises par ce workspace.',
  integrationsStripeConnect: 'Stripe Connect',
  integrationsPaypal: 'PayPal',
  integrationsRedsys: 'Redsys',
  integrationsComingSoon: 'BientÃ´t',
  integrationsRequiresSetup: 'NÃ©cessite la configuration OAuth avant que les utilisateurs puissent connecter leur compte.',
  integrationsConfigured: 'ConfigurÃ©',
  integrationsNotConfigured: 'Non configurÃ©',
}
...
const de: DashboardTranslations = {
  ...
  groupContent: 'Inhalt',
  groupSystem: 'System',
  descToday: 'Ihre ausstehenden Aufgaben und TeamaktivitÃ¤ten heute',
  descCopilot: 'Ihr strategischer Berater â€” teilen Sie Ihre Ziele und er hilft Ihnen, diese zu planen',
  descBrain: 'Workspace-GedÃ¤chtnis abfragen â€” Dokumente, Ziele und Entscheidungen',
  descMail: 'Posteingang, Gesendet, EntwÃ¼rfe und Kunden-E-Mails',
  descClients: 'Die Unternehmen oder Personen, denen Sie Dienstleistungen erbringen',
  descLeads: 'Potenzielle Kunden aus Ihrem Ã¶ffentlichen Formular',
  descTasks: 'Teamaufgaben mit kollaborativer Etikettierung',
  descTools: 'Die Tools, die Sie fÃ¼r Ihr Unternehmen installiert oder erstellt haben',
  descWorkflows: 'Verketten Sie mehrere Tools zur Automatisierung eines vollstÃ¤ndigen Prozesses',
  descOffice: 'Dokumente, Tabellen, PDFs, VertrÃ¤ge und PrÃ¤sentationen',
  descFiles: 'Workspace-Dateispeicher mit ZIP-Export',
  descMissions: 'Strategische Ziele und ihre AusfÃ¼hrungsschritte',
  descFiscal: 'Steuerlicher Verpflichtungskalender fÃ¼r Ihr Unternehmen',
  descInvoices: 'Erstellen und verwalten Sie Rechnungen fÃ¼r Kunden mit herunterladbarem PDF',
  descReceipts: 'Belege und Rechnungen mit der Kamera scannen â€” KI extrahiert die Daten',
  descAnalytics: 'AktivitÃ¤t, AusfÃ¼hrungen und Kosten Ihres Workspaces',
  ...
  descAdminOrg: 'Mitglieder, PlÃ¤ne und Konfiguration Ihrer Organisation',
  descProfile: 'Ihr Profilfoto und persÃ¶nliche Einstellungen',
  ...
  closeTeamPanel: 'Team-Panel schlieÃŸen',
  openTeamPanel: 'Team-Panel Ã¶ffnen',
  ...
  sectionPdfs: 'PDFs',
  sectionContracts: 'VertrÃ¤ge',
  sectionPresentations: 'PrÃ¤sentationen',
  sectionNotebooks: 'NotizbÃ¼cher',
  sectionOffice: 'Mein BÃ¼ro',
  ...
  subRecords: 'EintrÃ¤ge',
  subChecklist: 'Checkliste',
  subScoring: 'Bewertung',
  subEdit: 'Bearbeiten',
  subNew: 'Neu',
  bannerEarlyAccess: 'FrÃ¼her Zugang',
  bannerCta: 'Begrenzte PlÃ¤tze Â· Jetzt beitreten und EinfÃ¼hrungspreis sichern',
  integrationsTitle: 'Integrationen',
  integrationsSubtitle: 'Verbinden Sie die Apps und Konten, die dieser Workspace fÃ¼r Kunden, Dokumente und Automatisierungen nutzt.',
  integrationsEmailTitle: 'E-Mail',
  ...
  integrationsCalendarDescription: 'Bereiten Sie Google Calendar oder Outlook Calendar fÃ¼r Anrufe, Fristen, Erinnerungen und Missionsplanung vor.',
  integrationsGoogleCalendar: 'Google Calendar',
  integrationsOutlookCalendar: 'Outlook Calendar',
  ...
  integrationsStorageDescription: 'Externen Speicher fÃ¼r Dokumente, VertrÃ¤ge, PDFs und Workspace-Backups vorbereiten.',
  integrationsGoogleDrive: 'Google Drive',
  integrationsOneDrive: 'OneDrive',
  integrationsDropbox: 'Dropbox',
  ...
  integrationsStorageOpenExport: 'Ã–ffnen',
  ...
  integrationsAiDescription: 'MITIKUS verwaltete KI standardmÃ¤ÃŸig nutzen und eigene API-SchlÃ¼ssel fÃ¼r erweiterte PlÃ¤ne vorbereiten.',
  integrationsMitikusAi: 'MITIKUS KI',
  integrationsOpenAi: 'OpenAI',
  integrationsAnthropic: 'Anthropic',
  integrationsGemini: 'Google Gemini',
  integrationsManagedByMitikus: 'Von MITIKUS verwaltet',
  integrationsAiOwnKeyConfigured: 'Eigener API-SchlÃ¼ssel konfiguriert',
  integrationsAiKeyLabel: 'API-SchlÃ¼ssel',
  integrationsAiKeyPlaceholder: 'API-SchlÃ¼ssel des Anbieters einfÃ¼gen',
  integrationsAiLabelLabel: 'Interne Bezeichnung',
  integrationsAiLabelPlaceholder: 'Beispiel: Agentur OpenAI-SchlÃ¼ssel',
  integrationsAiSecurityNote: 'Der SchlÃ¼ssel wird vor dem Speichern verschlÃ¼sselt.',
  ...
  integrationsSignatureDescription: 'MITIKUS OTP-Signatur standardmÃ¤ÃŸig nutzen und externe Anbieter fÃ¼r erweiterte VertragsablÃ¤ufe vorbereiten.',
  integrationsMitikusSignature: 'MITIKUS Signatur',
  integrationsSignaturit: 'Signaturit',
  integrationsDocuSign: 'DocuSign',
  integrationsCommunicationTitle: 'Kommunikation',
  integrationsCommunicationDescription: 'Kunden-Nachrichten fÃ¼r Lead-Nachverfolgung, Rechnungserinnerungen und Workflow-Benachrichtigungen vorbereiten.',
  integrationsWhatsAppBusiness: 'WhatsApp Business',
  integrationsTwilio: 'Twilio',
  integrationsFormsTitle: 'Formulare und Lead-Erfassung',
  integrationsFormsDescription: 'Externe Formulare vorbereiten, damit Antworten Leads, Kunden, Aufgaben, VertrÃ¤ge oder Missionen in MITIKUS erstellen kÃ¶nnen.',
  integrationsTypeform: 'Typeform',
  integrationsGoogleForms: 'Google Forms',
  integrationsTally: 'Tally',
  integrationsJotform: 'Jotform',
  ...
  integrationsVideoCallsDescription: 'Online-Meeting-Links fÃ¼r Kunden, Missionen, VertrÃ¤ge und geplante Nachverfolgungen vorbereiten.',
  integrationsGoogleMeet: 'Google Meet',
  integrationsMicrosoftTeams: 'Microsoft Teams',
  integrationsZoom: 'Zoom',
  integrationsAutomationTitle: 'Externe Automatisierungen',
  integrationsAutomationDescription: 'Make-, Zapier- und n8n-Verbindungen vorbereiten, damit MITIKUS-Workflows spÃ¤ter externe Prozesse auslÃ¶sen kÃ¶nnen.',
  integrationsMake: 'Make',
  integrationsZapier: 'Zapier',
  integrationsN8n: 'n8n',
  integrationsAccountingTitle: 'Buchhaltung',
  integrationsAccountingDescription: 'Exporte und spÃ¤tere Synchronisierung mit Buchhaltungstools fÃ¼r SelbstÃ¤ndige, Agenturen und KMU vorbereiten.',
  integrationsHolded: 'Holded',
  integrationsSage: 'Sage',
  integrationsQuipu: 'Quipu',
  integrationsAnfix: 'Anfix',
  integrationsContasimple: 'Contasimple',
  integrationsEcommerceTitle: 'E-Commerce',
  integrationsEcommerceDescription: 'Online-Shop-Verbindungen vorbereiten, um Kunden, Bestellungen, Produkte und abrechnungsbereite VerkÃ¤ufe zu importieren.',
  integrationsShopify: 'Shopify',
  integrationsWooCommerce: 'WooCommerce',
  integrationsPrestashop: 'Prestashop',
  integrationsPaymentsTitle: 'Rechnungszahlungen',
  integrationsPaymentsDescription: 'ZukÃ¼nftige Zahlungslinks vorbereiten, damit Kunden Rechnungen dieses Workspaces bezahlen kÃ¶nnen.',
  integrationsStripeConnect: 'Stripe Connect',
  integrationsPaypal: 'PayPal',
  integrationsRedsys: 'Redsys',
  integrationsComingSoon: 'DemnÃ¤chst',
  integrationsRequiresSetup: 'OAuth muss eingerichtet werden, bevor Nutzer ihr Konto verbinden kÃ¶nnen.',
...
const pt: DashboardTranslations = {
  ...
  navWorkflows: 'Fluxos',
  navOffice: 'O meu EscritÃ³rio',
  navFiles: 'Ficheiros',
  navMissions: 'MissÃµes',
  navFiscal: 'CalendÃ¡rio Fiscal',
  navInvoices: 'Faturas',
  navReceipts: 'Despesas',
  navAnalytics: 'AnalÃ­tica',
  navUsage: 'UtilizaÃ§Ã£o do plano',
  navAudit: 'Auditoria',
  navAdminOrg: 'Admin Org',
  navProfile: 'O meu perfil',
  navSupport: 'Suporte',
  navSettings: 'DefiniÃ§Ãµes',
  navIntegrations: 'IntegraÃ§Ãµes',
  groupWork: 'Trabalho',
  groupContent: 'ConteÃºdo',
  groupSystem: 'Sistema',
  descToday: 'As suas tarefas pendentes e atividade da equipa hoje',
  descCopilot: 'O seu conselheiro estratÃ©gico â€” partilhe os seus objetivos e ajuda-o a planeÃ¡-los',
  descBrain: 'Consulte a memÃ³ria do workspace â€” documentos, objetivos e decisÃµes',
  descMail: 'Recebidos, enviados, rascunhos e emails de clientes',
  descClients: 'As empresas ou pessoas a quem presta serviÃ§os',
  descLeads: 'Potenciais clientes captados a partir do seu formulÃ¡rio pÃºblico',
  descTasks: 'Tarefas da equipa com etiquetagem colaborativa',
  descTools: 'As ferramentas que instalou ou criou para o seu negÃ³cio',
  descWorkflows: 'Encadeie vÃ¡rias ferramentas para automatizar um processo completo',
  descOffice: 'Documentos, folhas de cÃ¡lculo, PDFs, contratos e apresentaÃ§Ãµes',
  descFiles: 'Armazenamento de ficheiros do workspace com exportaÃ§Ã£o ZIP',
  descMissions: 'Objetivos estratÃ©gicos e os seus passos de execuÃ§Ã£o',
  descFiscal: 'CalendÃ¡rio de obrigaÃ§Ãµes fiscais para a sua empresa',
  descInvoices: 'Crie e gira faturas para os seus clientes com PDF descarregÃ¡vel',
  descReceipts: 'Digitalize tickets e faturas com a cÃ¢mara â€” a IA extrai os dados',
  descAnalytics: 'Atividade, execuÃ§Ãµes e custos do seu workspace',
  descUsage: 'Quanto gerou este mÃªs e quanto resta do seu plano',
  descAudit: 'Registo de quem fez o quÃª e quando neste workspace',
  descAdminOrg: 'Membros, planos e configuraÃ§Ã£o da sua organizaÃ§Ã£o',
  descProfile: 'A sua foto de perfil e preferÃªncias pessoais',
  descSupport: 'Assistente de ajuda e contacto com a equipa MITIKUS',
  descSettings: 'LogÃ³tipo, cor de marca e nome do workspace',
  descIntegrations: 'Ligue apps e serviÃ§os externos a este workspace',
  ...
  sectionClients: 'Clientes',
  sectionAnalytics: 'AnalÃ­tica',
  sectionAudit: 'Auditoria',
  sectionUsage: 'UtilizaÃ§Ã£o',
  sectionIntegrations: 'IntegraÃ§Ãµes',
  sectionTeam: 'Equipa',
  sectionSettings: 'DefiniÃ§Ãµes',
  ...
  sectionMissions: 'MissÃµes',
  sectionProfile: 'O meu perfil',
  sectionDocs: 'Documentos',
  sectionSheets: 'Folhas de cÃ¡lculo',
  sectionPdfs: 'PDFs',
  sectionContracts: 'Contratos',
  sectionPresentations: 'ApresentaÃ§Ãµes',
  sectionNotebooks: 'Cadernos',
  sectionOffice: 'O meu EscritÃ³rio',
  sectionHistory: 'HistÃ³rico',
  sectionInvoices: 'Faturas',
  sectionReceipts: 'Despesas',
  subHistory: 'HistÃ³rico',
  subRun: 'Executar',
  subSettings: 'DefiniÃ§Ãµes',
  subRecords: 'Registos',
  subChecklist: 'Checklist',
  subScoring: 'PontuaÃ§Ã£o',
  subEdit: 'Editar',
  subNew: 'Novo',
  bannerEarlyAccess: 'Acesso antecipado',
  bannerCta: 'Vagas limitadas Â· Junte-se agora e bloqueie o seu preÃ§o de lanÃ§amento',
  integrationsTitle: 'IntegraÃ§Ãµes',
  integrationsSubtitle: 'Ligue as apps e contas que este workspace usa para trabalhar com clientes, documentos e automatizaÃ§Ãµes.',
  integrationsEmailTitle: 'Correio',
  integrationsEmailDescription: 'Envie e receba emails de clientes com MITIKUS, Gmail, Outlook ou a sua prÃ³pria conta SMTP/IMAP.',
  integrationsCalendarTitle: 'CalendÃ¡rio',
  integrationsCalendarDescription: 'Prepare o Google Calendar ou Outlook Calendar para chamadas, prazos, lembretes e planeamento de missÃµes.',
  integrationsGoogleCalendar: 'Google Calendar',
  integrationsOutlookCalendar: 'Outlook Calendar',
  ...
  integrationsCalendarConnectedAccount: 'Conta de calendÃ¡rio ligada',
  integrationsCalendarConnectError: 'NÃ£o foi possÃ­vel iniciar a ligaÃ§Ã£o ao calendÃ¡rio.',
  integrationsCalendarDisconnectError: 'NÃ£o foi possÃ­vel desligar o calendÃ¡rio.',
  integrationsStorageTitle: 'Armazenamento',
  integrationsStorageDescription: 'Prepare armazenamento externo para documentos, contratos, PDFs e cÃ³pias do workspace.',
  integrationsGoogleDrive: 'Google Drive',
  integrationsOneDrive: 'OneDrive',
  integrationsDropbox: 'Dropbox',
  integrationsStorageConnectedAccount: 'Conta de armazenamento ligada',
  integrationsStorageConnectError: 'NÃ£o foi possÃ­vel iniciar a ligaÃ§Ã£o ao armazenamento.',
  integrationsStorageDisconnectError: 'NÃ£o foi possÃ­vel desligar a conta de armazenamento.',
  ...
  integrationsStorageOpenExport: 'Abrir',
  integrationsStorageExportError: 'NÃ£o foi possÃ­vel guardar o ZIP de ficheiros no armazenamento ligado.',
  integrationsAiTitle: 'Fornecedores de IA',
  integrationsAiDescription: 'Use a IA gerida pela MITIKUS por defeito e prepare chaves prÃ³prias para planos avanÃ§ados.',
  integrationsMitikusAi: 'MITIKUS IA',
  integrationsOpenAi: 'OpenAI',
  integrationsAnthropic: 'Anthropic',
  integrationsGemini: 'Google Gemini',
  integrationsManagedByMitikus: 'Gerido pela MITIKUS',
  integrationsAiOwnKeyConfigured: 'Chave API prÃ³pria configurada',
  integrationsAiKeyLabel: 'Chave API',
  integrationsAiKeyPlaceholder: 'Cole a chave API do fornecedor',
  integrationsAiLabelLabel: 'Etiqueta interna',
  integrationsAiLabelPlaceholder: 'Exemplo: chave OpenAI agÃªncia',
  integrationsAiSecurityNote: 'A chave Ã© cifrada antes de ser guardada.',
  integrationsAiSave: 'Guardar fornecedor',
  integrationsAiSaving: 'A guardar...',
  integrationsAiSaved: 'Fornecedor de IA guardado.',
  integrationsAiSaveError: 'NÃ£o foi possÃ­vel guardar o fornecedor de IA.',
  integrationsAiDisconnectError: 'NÃ£o foi possÃ­vel desligar o fornecedor de IA.',
  integrationsSignatureTitle: 'Assinatura digital',
  integrationsSignatureDescription: 'Use a assinatura OTP da MITIKUS por defeito e prepare fornecedores externos para contratos avanÃ§ados.',
  integrationsMitikusSignature: 'Assinatura MITIKUS',
  integrationsSignaturit: 'Signaturit',
  integrationsDocuSign: 'DocuSign',
  integrationsCommunicationTitle: 'ComunicaÃ§Ã£o',
  ...
  integrationsWhatsAppBusiness: 'WhatsApp Business',
  integrationsTwilio: 'Twilio',
  integrationsFormsTitle: 'FormulÃ¡rios e captaÃ§Ã£o',
  integrationsFormsDescription: 'Prepare formulÃ¡rios externos para que as respostas possam criar leads, clientes, tarefas, contratos ou missÃµes na MITIKUS.',
  integrationsTypeform: 'Typeform',
  integrationsGoogleForms: 'Google Forms',
  integrationsTally: 'Tally',
  integrationsJotform: 'Jotform',
  ...
  integrationsVideoCallsDescription: 'Prepare links de reuniÃ£o online para clientes, missÃµes, contratos e acompanhamentos programados.',
  integrationsGoogleMeet: 'Google Meet',
  integrationsMicrosoftTeams: 'Microsoft Teams',
  integrationsZoom: 'Zoom',
  integrationsAutomationTitle: 'AutomatizaÃ§Ãµes externas',
  integrationsAutomationDescription: 'Prepare ligaÃ§Ãµes com Make, Zapier e n8n para que os fluxos da MITIKUS possam acionar processos externos mais tarde.',
  integrationsMake: 'Make',
  integrationsZapier: 'Zapier',
  integrationsN8n: 'n8n',
  integrationsAccountingTitle: 'Contabilidade',
  integrationsAccountingDescription: 'Prepare exportaÃ§Ãµes e futura sincronizaÃ§Ã£o com ferramentas contabilÃ­sticas usadas por freelancers, agÃªncias e PMEs.',
  integrationsHolded: 'Holded',
  integrationsSage: 'Sage',
  integrationsQuipu: 'Quipu',
  integrationsAnfix: 'Anfix',
  integrationsContasimple: 'Contasimple',
  integrationsEcommerceTitle: 'E-commerce',
  integrationsEcommerceDescription: 'Prepare ligaÃ§Ãµes com lojas online para importar clientes, encomendas, produtos e vendas prontas para faturar.',
  integrationsShopify: 'Shopify',
  integrationsWooCommerce: 'WooCommerce',
  integrationsPrestashop: 'Prestashop',
  ...
  integrationsRequiresSetup: 'Requer configuraÃ§Ã£o OAuth antes de os utilizadores poderem ligar a sua conta.',
  integrationsConfigured: 'Configurado',
  integrationsNotConfigured: 'NÃ£o configurado',
  todayGreetingMorning: 'Bom dia',
  todayGreetingAfternoon: 'Boa tarde',
  todayGreetingEvening: 'Boa noite',
  todayFallbackName: 'utilizador',
  todayArkosStepTitle: 'Definir a primeira missÃ£o',
  todayArkosStepDescription: 'Conte Ã  Arkos o que quer alcanÃ§ar e transforme-o num plano.',
  todayClientStepTitle: 'Adicionar um cliente',
  todayClientStepDescription: 'Crie o seu primeiro dossiÃª de cliente para organizar trabalho e documentos.',
  todayTaskStepTitle: 'Criar uma tarefa',
  todayTaskStepDescription: 'Registe uma aÃ§Ã£o simples para comeÃ§ar a acompanhar o trabalho.',
  todayInvoiceStepTitle: 'Criar uma fatura',
  todayInvoiceStepDescription: 'Prepare a sua primeira fatura com PDF descarregÃ¡vel.',
  todayFiscalStepTitle: 'Configurar fiscalidade',
  todayFiscalStepDescription: 'Indique paÃ­s e forma jurÃ­dica para ver obrigaÃ§Ãµes fiscais.',
  todayTimeTracking: 'Registo de tempo',
  todayViewHistory: 'Ver histÃ³rico',
  todayMyTasks: 'As minhas tarefas',
  todayViewAll: 'Ver tudo',
  todayAllCaughtUpTitle: 'EstÃ¡ tudo em dia. Bom trabalho.',
  todayAllCaughtUpDescription: 'NÃ£o tem passos nem fluxos pendentes.',
  todayAskArkosMission: 'Pedir uma nova missÃ£o Ã  Arkos',
  ...
  todayStatusRunning: 'Em execuÃ§Ã£o',
  todayStatusCompleted: 'ConcluÃ­do',
  todayStatusFailed: 'Falhou',
  todayStatusCancelled: 'Cancelado',
  todayClockNotStarted: 'Sem entrada registada',
  todayClockElapsedPrefix: 'Tempo registado',
  todayClockInLabel: 'Entrada',
  todayClockCompleted: 'Turno concluÃ­do',
  todayClockInAction: 'Registar entrada',
  todayClockOutAction: 'Registar saÃ­da',
  todayClockWorking: 'A trabalhar',
  todayClockInError: 'NÃ£o foi possÃ­vel registar a entrada.',
  todayClockOutError: 'NÃ£o foi possÃ­vel registar a saÃ­da.',
  ...
  todayFiscalSetupTitle: 'Configurar calendÃ¡rio fiscal',
  todayFiscalSetupDescription: 'Complete os dados fiscais para ver os prÃ³ximos prazos.',
  todayConfigure: 'Configurar',
  todayUpcomingFiscal: 'PrÃ³ximas obrigaÃ§Ãµes',
  todayViewCalendar: 'Ver calendÃ¡rio',
  todayToday: 'Hoje',
  todayCalculate: 'Calcular',
  ...
  todayCompletedProgress: 'concluÃ­dos',
}
...
const it: DashboardTranslations = {
  ...
  groupSystem: 'Sistema',
  descToday: 'Le tue attivitÃ  in sospeso e l\'attivitÃ  del team oggi',
  descCopilot: 'Il tuo consulente strategico â€” condividi i tuoi obiettivi e ti aiuta a pianificarli',
  descBrain: 'Interroga la memoria del workspace â€” documenti, obiettivi e decisioni',
  ...
  descTasks: 'AttivitÃ  del team con etichettatura collaborativa',
  descTools: 'Gli strumenti che hai installato o creato per la tua attivitÃ ',
  descWorkflows: 'Collega piÃ¹ strumenti per automatizzare un processo completo',
  ...
  descReceipts: 'Scansiona scontrini e fatture con la fotocamera â€” l\'IA estrae i dati',
  descAnalytics: 'AttivitÃ , esecuzioni e costi del tuo workspace',
  ...
  bannerCta: 'Posti limitati Â· Unisciti ora e blocca il tuo prezzo di lancio',
  ...
  integrationsStorageDescription: 'Prepara lâ€™archiviazione esterna per documenti, contratti, PDF e backup del workspace.',
  integrationsGoogleDrive: 'Google Drive',
  integrationsOneDrive: 'OneDrive',
  integrationsDropbox: 'Dropbox',
  integrationsStorageConnectedAccount: 'Account di archiviazione collegato',
  integrationsStorageConnectError: 'Impossibile avviare il collegamento dellâ€™archiviazione.',
  integrationsStorageDisconnectError: 'Impossibile disconnettere lâ€™account di archiviazione.',
  integrationsStorageExportFiles: 'Salva ZIP dei file',
  integrationsStorageExporting: 'Salvataggio...',
  integrationsStorageExported: 'ZIP dei file salvato nellâ€™archiviazione collegata.',
  integrationsStorageOpenExport: 'Apri',
  integrationsStorageExportError: 'Impossibile salvare lo ZIP dei file nellâ€™archiviazione collegata.',
  integrationsAiTitle: 'Provider IA',
  integrationsAiDescription: 'Usa lâ€™IA gestita da MITIKUS per impostazione predefinita e prepara chiavi proprie per i piani avanzati.',
  integrationsMitikusAi: 'MITIKUS IA',
  integrationsOpenAi: 'OpenAI',
  integrationsAnthropic: 'Anthropic',
  integrationsGemini: 'Google Gemini',
  ...
  integrationsFormsDescription: 'Prepara moduli esterni affinchÃ© le risposte possano creare lead, clienti, attivitÃ , contratti o missioni in MITIKUS.',
  integrationsTypeform: 'Typeform',
  integrationsGoogleForms: 'Google Forms',
  integrationsTally: 'Tally',
  integrationsJotform: 'Jotform',
  ...
  integrationsAutomationDescription: 'Prepara connessioni con Make, Zapier e n8n affinchÃ© i flussi MITIKUS possano attivare processi esterni in seguito.',
  integrationsMake: 'Make',
  integrationsZapier: 'Zapier',
  integrationsN8n: 'n8n',
  integrationsAccountingTitle: 'ContabilitÃ ',
  ...
  integrationsPaymentsDescription: 'Prepara futuri link di pagamento affinchÃ© i clienti possano pagare le fatture emesse da questo workspace.',
  integrationsStripeConnect: 'Stripe Connect',
  integrationsPaypal: 'PayPal',
  integrationsRedsys: 'Redsys',
...
const nl = fromEn({
  ...
  bannerEarlyAccess: 'Vroegtijdige toegang', bannerCta: 'Beperkte plaatsen Â· Meld u nu aan en blokkeer uw lanceringsprijs',
})

const pl = fromEn({
  navToday: 'MÃ³j dzieÅ„', navMail: 'Poczta', navClients: 'Klienci', navTasks: 'Zadania',
  navTools: 'NarzÄ™dzia', navWorkflows: 'PrzepÅ‚ywy', navOffice: 'Moje biuro', navFiles: 'Pliki',
  navMissions: 'Misje', navFiscal: 'Kalendarz podatkowy', navInvoices: 'Faktury', navReceipts: 'Wydatki',
  navAnalytics: 'Analityka', navUsage: 'UÅ¼ycie planu', navProfile: 'MÃ³j profil', navSettings: 'Ustawienia',
  groupWork: 'Praca', groupContent: 'TreÅ›Ä‡', groupSystem: 'System',
  newMission: 'Nowa misja', expandSidebar: 'RozwiÅ„ pasek boczny', collapseSidebar: 'ZwiÅ„ pasek boczny',
  openMenu: 'OtwÃ³rz menu', closeTeamPanel: 'Zamknij panel zespoÅ‚u', openTeamPanel: 'OtwÃ³rz panel zespoÅ‚u',
  bannerEarlyAccess: 'Wczesny dostÄ™p', bannerCta: 'Ograniczone miejsca Â· DoÅ‚Ä…cz teraz i zablokuj cenÄ™ startowÄ…',
})

const ro = fromEn({
  navToday: 'Ziua mea', navMail: 'E-mail', navClients: 'ClienÈ›i', navTasks: 'Sarcini',
  navTools: 'Instrumente', navWorkflows: 'Fluxuri', navOffice: 'Biroul meu', navFiles: 'FiÈ™iere',
  navMissions: 'Misiuni', navFiscal: 'Calendar fiscal', navInvoices: 'Facturi', navReceipts: 'Cheltuieli',
  navAnalytics: 'AnalizÄƒ', navUsage: 'Utilizare plan', navProfile: 'Profilul meu', navSettings: 'SetÄƒri',
  groupWork: 'MuncÄƒ', groupContent: 'ConÈ›inut', groupSystem: 'Sistem',
  newMission: 'Misiune nouÄƒ', expandSidebar: 'Extinde bara lateralÄƒ', collapseSidebar: 'RestrÃ¢nge bara lateralÄƒ',
  openMenu: 'Deschide meniu', closeTeamPanel: 'ÃŽnchide panoul echipei', openTeamPanel: 'Deschide panoul echipei',
  bannerEarlyAccess: 'Acces anticipat', bannerCta: 'Locuri limitate Â· AlÄƒturaÈ›i-vÄƒ acum È™i blocaÈ›i preÈ›ul de lansare',
})

const sv = fromEn({
  navToday: 'Min dag', navMail: 'E-post', navClients: 'Kunder', navTasks: 'Uppgifter',
  navTools: 'Verktyg', navWorkflows: 'ArbetsflÃ¶den', navOffice: 'Mitt kontor', navFiles: 'Filer',
  navMissions: 'Uppdrag', navFiscal: 'Skattekalender', navInvoices: 'Fakturor', navReceipts: 'Utgifter',
  navAnalytics: 'Analys', navUsage: 'PlananvÃ¤ndning', navProfile: 'Min profil', navSettings: 'InstÃ¤llningar',
  groupWork: 'Arbete', groupContent: 'InnehÃ¥ll', groupSystem: 'System',
  newMission: 'Nytt uppdrag', expandSidebar: 'Expandera sidofÃ¤lt', collapseSidebar: 'Kollapsa sidofÃ¤lt',
  openMenu: 'Ã–ppna meny', closeTeamPanel: 'StÃ¤ng teampanel', openTeamPanel: 'Ã–ppna teampanel',
  bannerEarlyAccess: 'Tidig Ã¥tkomst', bannerCta: 'BegrÃ¤nsade platser Â· GÃ¥ med nu och lÃ¥s ditt lanseringspris',
})

const da = fromEn({
  navToday: 'Min dag', navMail: 'E-mail', navClients: 'Kunder', navTasks: 'Opgaver',
  navTools: 'VÃ¦rktÃ¸jer', navWorkflows: 'Arbejdsflows', navOffice: 'Mit kontor', navFiles: 'Filer',
  ...
  newMission: 'Ny mission', expandSidebar: 'Udvid sidebjÃ¦lke', collapseSidebar: 'Skjul sidebjÃ¦lke',
  openMenu: 'Ã…bn menu', closeTeamPanel: 'Luk teampanel', openTeamPanel: 'Ã…bn teampanel',
  bannerEarlyAccess: 'Tidlig adgang', bannerCta: 'BegrÃ¦nsede pladser Â· Tilmeld dig nu og lÃ¥s din lanceringspris',
})

const no = fromEn({
  navToday: 'Min dag', navMail: 'E-post', navClients: 'Kunder', navTasks: 'Oppgaver',
  navTools: 'VerktÃ¸y', navWorkflows: 'Arbeidsflyter', navOffice: 'Mitt kontor', navFiles: 'Filer',
  ...
  openMenu: 'Ã…pne meny', closeTeamPanel: 'Lukk teampanel', openTeamPanel: 'Ã…pne teampanel',
  bannerEarlyAccess: 'Tidlig tilgang', bannerCta: 'Begrenset antall plasser Â· Bli med nÃ¥ og lÃ¥s startprisen',
})

const hu = fromEn({
  navToday: 'Az Ã©n napom', navMail: 'E-mail', navClients: 'Ãœgyfelek', navTasks: 'Feladatok',
  navTools: 'EszkÃ¶zÃ¶k', navWorkflows: 'Munkafolyamatok', navOffice: 'IrodÃ¡m', navFiles: 'FÃ¡jlok',
  navMissions: 'MissziÃ³k', navFiscal: 'AdÃ³naptÃ¡r', navInvoices: 'SzÃ¡mlÃ¡k', navReceipts: 'KiadÃ¡sok',
  navAnalytics: 'ElemzÃ©s', navUsage: 'TervhasznÃ¡lat', navProfile: 'Profilom', navSettings: 'BeÃ¡llÃ­tÃ¡sok',
  groupWork: 'Munka', groupContent: 'Tartalom', groupSystem: 'Rendszer',
  newMission: 'Ãšj missziÃ³', expandSidebar: 'OldalsÃ¡v kibontÃ¡sa', collapseSidebar: 'OldalsÃ¡v Ã¶sszecsukÃ¡sa',
  openMenu: 'MenÃ¼ megnyitÃ¡sa', closeTeamPanel: 'Csapat panel bezÃ¡rÃ¡sa', openTeamPanel: 'Csapat panel megnyitÃ¡sa',
  bannerEarlyAccess: 'Korai hozzÃ¡fÃ©rÃ©s', bannerCta: 'KorlÃ¡tozott helyek Â· Csatlakozzon most Ã©s rÃ¶gzÃ­tse az indÃ­tÃ¡si Ã¡rat',
})

const cs = fromEn({
  navToday: 'MÅ¯j den', navMail: 'E-mail', navClients: 'Klienti', navTasks: 'Ãškoly',
  navTools: 'NÃ¡stroje', navWorkflows: 'PracovnÃ­ postupy', navOffice: 'MÃ¡ kancelÃ¡Å™', navFiles: 'Soubory',
  navMissions: 'Mise', navFiscal: 'DaÅˆovÃ½ kalendÃ¡Å™', navInvoices: 'Faktury', navReceipts: 'VÃ½daje',
  navAnalytics: 'Analytika', navUsage: 'VyuÅ¾itÃ­ plÃ¡nu', navProfile: 'MÅ¯j profil', navSettings: 'NastavenÃ­',
  groupWork: 'PrÃ¡ce', groupContent: 'Obsah', groupSystem: 'SystÃ©m',
  newMission: 'NovÃ¡ mise', expandSidebar: 'Rozbalit postrannÃ­ panel', collapseSidebar: 'Sbalit postrannÃ­ panel',
  openMenu: 'OtevÅ™Ã­t nabÃ­dku', closeTeamPanel: 'ZavÅ™Ã­t panel tÃ½mu', openTeamPanel: 'OtevÅ™Ã­t panel tÃ½mu',
  bannerEarlyAccess: 'PÅ™edÄasnÃ½ pÅ™Ã­stup', bannerCta: 'OmezenÃ½ poÄet mÃ­st Â· PÅ™ipojte se nynÃ­ a zajistÄ›te si cenu pÅ™i spuÅ¡tÄ›nÃ­',
})

const sk = fromEn({
  navToday: 'MÃ´j deÅˆ', navMail: 'E-mail', navClients: 'Klienti', navTasks: 'Ãšlohy',
  navTools: 'NÃ¡stroje', navWorkflows: 'PracovnÃ© postupy', navOffice: 'Moja kancelÃ¡ria', navFiles: 'SÃºbory',
  navMissions: 'Misie', navFiscal: 'DaÅˆovÃ½ kalendÃ¡r', navInvoices: 'FaktÃºry', navReceipts: 'VÃ½davky',
  navAnalytics: 'Analytika', navUsage: 'VyuÅ¾itie plÃ¡nu', navProfile: 'MÃ´j profil', navSettings: 'Nastavenia',
  groupWork: 'PrÃ¡ca', groupContent: 'Obsah', groupSystem: 'SystÃ©m',
  newMission: 'NovÃ¡ misia', expandSidebar: 'RozbaliÅ¥ boÄnÃ½ panel', collapseSidebar: 'ZbaliÅ¥ boÄnÃ½ panel',
  openMenu: 'OtvoriÅ¥ ponuku', closeTeamPanel: 'ZatvoriÅ¥ panel tÃ­mu', openTeamPanel: 'OtvoriÅ¥ panel tÃ­mu',
  bannerEarlyAccess: 'SkorÃ½ prÃ­stup', bannerCta: 'ObmedzenÃ½ poÄet miest Â· Pripojte sa teraz a zabezpeÄte si cenu pri spustenÃ­',
})

const el = fromEn({
  navToday: 'Î— Î¼Î­ÏÎ± Î¼Î¿Ï…', navMail: 'E-mail', navClients: 'Î ÎµÎ»Î¬Ï„ÎµÏ‚', navTasks: 'Î•ÏÎ³Î±ÏƒÎ¯ÎµÏ‚',
  navTools: 'Î•ÏÎ³Î±Î»ÎµÎ¯Î±', navWorkflows: 'Î¡Î¿Î­Ï‚ ÎµÏÎ³Î±ÏƒÎ¯Î±Ï‚', navOffice: 'Î¤Î¿ Î³ÏÎ±Ï†ÎµÎ¯Î¿ Î¼Î¿Ï…', navFiles: 'Î‘ÏÏ‡ÎµÎ¯Î±',
  navMissions: 'Î‘Ï€Î¿ÏƒÏ„Î¿Î»Î­Ï‚', navFiscal: 'Î¦Î¿ÏÎ¿Î»Î¿Î³Î¹ÎºÏŒ Î·Î¼ÎµÏÎ¿Î»ÏŒÎ³Î¹Î¿', navInvoices: 'Î¤Î¹Î¼Î¿Î»ÏŒÎ³Î¹Î±', navReceipts: 'ÎˆÎ¾Î¿Î´Î±',
  navAnalytics: 'Î‘Î½Î±Î»Ï…Ï„Î¹ÎºÎ¬', navUsage: 'Î§ÏÎ®ÏƒÎ· Ï€Î»Î¬Î½Î¿Ï…', navProfile: 'Î¤Î¿ Ï€ÏÎ¿Ï†Î¯Î» Î¼Î¿Ï…', navSettings: 'Î¡Ï…Î¸Î¼Î¯ÏƒÎµÎ¹Ï‚',
  groupWork: 'Î•ÏÎ³Î±ÏƒÎ¯Î±', groupContent: 'Î ÎµÏÎ¹ÎµÏ‡ÏŒÎ¼ÎµÎ½Î¿', groupSystem: 'Î£ÏÏƒÏ„Î·Î¼Î±',
  newMission: 'ÎÎ­Î± Î±Ï€Î¿ÏƒÏ„Î¿Î»Î®', expandSidebar: 'Î‘Î½Î¬Ï€Ï„Ï…Î¾Î· Ï€Î»Î±ÏŠÎ½Î®Ï‚ Î¼Ï€Î¬ÏÎ±Ï‚', collapseSidebar: 'Î£ÏÎ¼Ï€Ï„Ï…Î¾Î· Ï€Î»Î±ÏŠÎ½Î®Ï‚ Î¼Ï€Î¬ÏÎ±Ï‚',
  openMenu: 'Î†Î½Î¿Î¹Î³Î¼Î± Î¼ÎµÎ½Î¿Ï', closeTeamPanel: 'ÎšÎ»ÎµÎ¯ÏƒÎ¹Î¼Î¿ Ï€Î¯Î½Î±ÎºÎ± Î¿Î¼Î¬Î´Î±Ï‚', openTeamPanel: 'Î†Î½Î¿Î¹Î³Î¼Î± Ï€Î¯Î½Î±ÎºÎ± Î¿Î¼Î¬Î´Î±Ï‚',
  bannerEarlyAccess: 'Î ÏÏŽÎ¹Î¼Î· Ï€ÏÏŒÏƒÎ²Î±ÏƒÎ·', bannerCta: 'Î ÎµÏÎ¹Î¿ÏÎ¹ÏƒÎ¼Î­Î½ÎµÏ‚ Î¸Î­ÏƒÎµÎ¹Ï‚ Â· Î•Î³Î³ÏÎ±Ï†ÎµÎ¯Ï„Îµ Ï„ÏŽÏÎ± ÎºÎ±Î¹ ÎºÎ»ÎµÎ¹Î´ÏŽÏƒÏ„Îµ Ï„Î·Î½ Ï„Î¹Î¼Î® ÎµÎºÎºÎ¯Î½Î·ÏƒÎ·Ï‚',
})

const fi = fromEn({
  navToday: 'PÃ¤ivÃ¤ni', navMail: 'SÃ¤hkÃ¶posti', navClients: 'Asiakkaat', navTasks: 'TehtÃ¤vÃ¤t',
  navTools: 'TyÃ¶kalut', navWorkflows: 'TyÃ¶nkulut', navOffice: 'Toimistoni', navFiles: 'Tiedostot',
  navMissions: 'TehtÃ¤vÃ¤t', navFiscal: 'Verokalenteri', navInvoices: 'Laskut', navReceipts: 'Kulut',
  navAnalytics: 'Analytiikka', navUsage: 'Suunnitelman kÃ¤yttÃ¶', navProfile: 'Profiilini', navSettings: 'Asetukset',
  groupWork: 'TyÃ¶', groupContent: 'SisÃ¤ltÃ¶', groupSystem: 'JÃ¤rjestelmÃ¤',
  newMission: 'Uusi tehtÃ¤vÃ¤', expandSidebar: 'Laajenna sivupalkki', collapseSidebar: 'TiivistÃ¤ sivupalkki',
  openMenu: 'Avaa valikko', closeTeamPanel: 'Sulje tiimipaneeli', openTeamPanel: 'Avaa tiimipaneeli',
  bannerEarlyAccess: 'Varhainen pÃ¤Ã¤sy', bannerCta: 'Rajoitettu mÃ¤Ã¤rÃ¤ paikkoja Â· Liity nyt ja lukitse julkaisuhinta',
})

const hr = fromEn({
  navToday: 'Moj dan', navMail: 'E-poÅ¡ta', navClients: 'Klijenti', navTasks: 'Zadaci',
  navTools: 'Alati', navWorkflows: 'Tijekovi rada', navOffice: 'Moj ured', navFiles: 'Datoteke',
  navMissions: 'Misije', navFiscal: 'Porezni kalendar', navInvoices: 'RaÄuni', navReceipts: 'TroÅ¡kovi',
  navAnalytics: 'Analitika', navUsage: 'KoriÅ¡tenje plana', navProfile: 'Moj profil', navSettings: 'Postavke',
  groupWork: 'Rad', groupContent: 'SadrÅ¾aj', groupSystem: 'Sustav',
  newMission: 'Nova misija', expandSidebar: 'ProÅ¡iri boÄnu traku', collapseSidebar: 'SaÅ¾mi boÄnu traku',
  openMenu: 'Otvori izbornik', closeTeamPanel: 'Zatvori panel tima', openTeamPanel: 'Otvori panel tima',
  bannerEarlyAccess: 'Rani pristup', bannerCta: 'OgraniÄena mjesta Â· PridruÅ¾ite se sada i zakljuÄajte svoju cijenu lansiranja',
})

const bg = fromEn({
  navToday: 'ÐœÐ¾ÑÑ‚ Ð´ÐµÐ½', navMail: 'ÐŸÐ¾Ñ‰Ð°', navClients: 'ÐšÐ»Ð¸ÐµÐ½Ñ‚Ð¸', navTasks: 'Ð—Ð°Ð´Ð°Ñ‡Ð¸',
  navTools: 'Ð˜Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚Ð¸', navWorkflows: 'Ð Ð°Ð±Ð¾Ñ‚Ð½Ð¸ Ð¿Ð¾Ñ‚Ð¾Ñ†Ð¸', navOffice: 'ÐœÐ¾ÑÑ‚ Ð¾Ñ„Ð¸Ñ', navFiles: 'Ð¤Ð°Ð¹Ð»Ð¾Ð²Ðµ',
  navMissions: 'ÐœÐ¸ÑÐ¸Ð¸', navFiscal: 'Ð”Ð°Ð½ÑŠÑ‡ÐµÐ½ ÐºÐ°Ð»ÐµÐ½Ð´Ð°Ñ€', navInvoices: 'Ð¤Ð°ÐºÑ‚ÑƒÑ€Ð¸', navReceipts: 'Ð Ð°Ð·Ñ…Ð¾Ð´Ð¸',
  navAnalytics: 'ÐÐ½Ð°Ð»Ð¸Ð·Ð¸', navUsage: 'Ð˜Ð·Ð¿Ð¾Ð»Ð·Ð²Ð°Ð½Ðµ Ð½Ð° Ð¿Ð»Ð°Ð½Ð°', navProfile: 'ÐœÐ¾ÑÑ‚ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»', navSettings: 'ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸',
  groupWork: 'Ð Ð°Ð±Ð¾Ñ‚Ð°', groupContent: 'Ð¡ÑŠÐ´ÑŠÑ€Ð¶Ð°Ð½Ð¸Ðµ', groupSystem: 'Ð¡Ð¸ÑÑ‚ÐµÐ¼Ð°',
  newMission: 'ÐÐ¾Ð²Ð° Ð¼Ð¸ÑÐ¸Ñ', expandSidebar: 'Ð Ð°Ð·Ð³ÑŠÐ½Ð¸ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ‡Ð½Ð°Ñ‚Ð° Ð»ÐµÐ½Ñ‚Ð°', collapseSidebar: 'Ð¡Ð²Ð¸Ð¹ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ‡Ð½Ð°Ñ‚Ð° Ð»ÐµÐ½Ñ‚Ð°',
  openMenu: 'ÐžÑ‚Ð²Ð¾Ñ€Ð¸ Ð¼ÐµÐ½ÑŽ', closeTeamPanel: 'Ð—Ð°Ñ‚Ð²Ð¾Ñ€Ð¸ Ð¿Ð°Ð½ÐµÐ»Ð° Ð½Ð° ÐµÐºÐ¸Ð¿Ð°', openTeamPanel: 'ÐžÑ‚Ð²Ð¾Ñ€Ð¸ Ð¿Ð°Ð½ÐµÐ»Ð° Ð½Ð° ÐµÐºÐ¸Ð¿Ð°',
  bannerEarlyAccess: 'Ð Ð°Ð½ÐµÐ½ Ð´Ð¾ÑÑ‚ÑŠÐ¿', bannerCta: 'ÐžÐ³Ñ€Ð°Ð½Ð¸Ñ‡ÐµÐ½Ð¸ Ð¼ÐµÑÑ‚Ð° Â· ÐŸÑ€Ð¸ÑÑŠÐµÐ´Ð¸Ð½ÐµÑ‚Ðµ ÑÐµ ÑÐµÐ³Ð° Ð¸ Ð·Ð°ÐºÐ»ÑŽÑ‡ÐµÑ‚Ðµ ÑÑ‚Ð°Ñ€Ñ‚Ð¾Ð²Ð°Ñ‚Ð° ÑÐ¸ Ñ†ÐµÐ½Ð°',
})

const sl = fromEn({
  navToday: 'Moj dan', navMail: 'E-poÅ¡ta', navClients: 'Stranke', navTasks: 'Naloge',
  navTools: 'Orodja', navWorkflows: 'Delovni tokovi', navOffice: 'Moja pisarna', navFiles: 'Datoteke',
  navMissions: 'Misije', navFiscal: 'DavÄni koledar', navInvoices: 'RaÄuni', navReceipts: 'StroÅ¡ki',
  navAnalytics: 'Analitika', navUsage: 'Uporaba naÄrta', navProfile: 'Moj profil', navSettings: 'Nastavitve',
  groupWork: 'Delo', groupContent: 'Vsebina', groupSystem: 'Sistem',
  newMission: 'Nova misija', expandSidebar: 'RazÅ¡iri stransko ploÅ¡Äo', collapseSidebar: 'SkrÄi stransko ploÅ¡Äo',
  openMenu: 'Odpri meni', closeTeamPanel: 'Zapri ploÅ¡Äo ekipe', openTeamPanel: 'Odpri ploÅ¡Äo ekipe',
  bannerEarlyAccess: 'Zgodnji dostop', bannerCta: 'Omejeno Å¡tevilo mest Â· PridruÅ¾ite se zdaj in si zagotovite ceno ob zagonu',
})

const ja = fromEn({
  navToday: 'ä»Šæ—¥', navMail: 'ãƒ¡ãƒ¼ãƒ«', navClients: 'ã‚¯ãƒ©ã‚¤ã‚¢ãƒ³ãƒˆ', navTasks: 'ã‚¿ã‚¹ã‚¯',
  navTools: 'ãƒ„ãƒ¼ãƒ«', navWorkflows: 'ãƒ¯ãƒ¼ã‚¯ãƒ•ãƒ­ãƒ¼', navOffice: 'ãƒžã‚¤ã‚ªãƒ•ã‚£ã‚¹', navFiles: 'ãƒ•ã‚¡ã‚¤ãƒ«',
  navMissions: 'ãƒŸãƒƒã‚·ãƒ§ãƒ³', navFiscal: 'ç¨Žå‹™ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼', navInvoices: 'è«‹æ±‚æ›¸', navReceipts: 'çµŒè²»',
  navAnalytics: 'åˆ†æž', navUsage: 'ãƒ—ãƒ©ãƒ³åˆ©ç”¨çŠ¶æ³', navProfile: 'ãƒ—ãƒ­ãƒ•ã‚£ãƒ¼ãƒ«', navSettings: 'è¨­å®š',
  groupWork: 'æ¥­å‹™', groupContent: 'ã‚³ãƒ³ãƒ†ãƒ³ãƒ„', groupSystem: 'ã‚·ã‚¹ãƒ†ãƒ ',
  newMission: 'æ–°ã—ã„ãƒŸãƒƒã‚·ãƒ§ãƒ³', expandSidebar: 'ã‚µã‚¤ãƒ‰ãƒãƒ¼ã‚’å±•é–‹', collapseSidebar: 'ã‚µã‚¤ãƒ‰ãƒãƒ¼ã‚’æŠ˜ã‚ŠãŸãŸã‚€',
  openMenu: 'ãƒ¡ãƒ‹ãƒ¥ãƒ¼ã‚’é–‹ã', closeTeamPanel: 'ãƒãƒ¼ãƒ ãƒ‘ãƒãƒ«ã‚’é–‰ã˜ã‚‹', openTeamPanel: 'ãƒãƒ¼ãƒ ãƒ‘ãƒãƒ«ã‚’é–‹ã',
  bannerEarlyAccess: 'ã‚¢ãƒ¼ãƒªãƒ¼ã‚¢ã‚¯ã‚»ã‚¹', bannerCta: 'é™å®šæž  Â· ä»Šã™ãå‚åŠ ã—ã¦ãƒ­ãƒ¼ãƒ³ãƒä¾¡æ ¼ã‚’ç¢ºä¿',
})

const zh = fromEn({
  navToday: 'æˆ‘çš„ä»Šå¤©', navMail: 'é‚®ä»¶', navClients: 'å®¢æˆ·', navTasks: 'ä»»åŠ¡',
  navTools: 'å·¥å…·', navWorkflows: 'å·¥ä½œæµ', navOffice: 'æˆ‘çš„åŠžå…¬å®¤', navFiles: 'æ–‡ä»¶',
  navMissions: 'ä»»åŠ¡ç›®æ ‡', navFiscal: 'ç¨ŽåŠ¡æ—¥åŽ†', navInvoices: 'å‘ç¥¨', navReceipts: 'è´¹ç”¨',
  navAnalytics: 'åˆ†æž', navUsage: 'è®¡åˆ’ä½¿ç”¨æƒ…å†µ', navProfile: 'æˆ‘çš„èµ„æ–™', navSettings: 'è®¾ç½®',
  groupWork: 'å·¥ä½œ', groupContent: 'å†…å®¹', groupSystem: 'ç³»ç»Ÿ',
  newMission: 'æ–°ä»»åŠ¡', expandSidebar: 'å±•å¼€ä¾§è¾¹æ ', collapseSidebar: 'æ”¶èµ·ä¾§è¾¹æ ',
  openMenu: 'æ‰“å¼€èœå•', closeTeamPanel: 'å…³é—­å›¢é˜Ÿé¢æ¿', openTeamPanel: 'æ‰“å¼€å›¢é˜Ÿé¢æ¿',
  bannerEarlyAccess: 'æ—©æœŸè®¿é—®', bannerCta: 'åé¢æœ‰é™ Â· ç«‹å³åŠ å…¥å¹¶é”å®šå‘å¸ƒä»·æ ¼',
})

const todayLocaleOverrides: Partial<Record<Locale, Partial<DashboardTranslations>>> = {
  fr: {
    todayGreetingMorning: 'Bonjour',
    todayGreetingAfternoon: 'Bon aprÃ¨s-midi',
    todayGreetingEvening: 'Bonsoir',
    todayFallbackName: 'utilisateur',
    todayTimeTracking: 'Suivi du temps',
    todayViewHistory: 'Voir lâ€™historique',
    todayAllCaughtUpTitle: 'Tout est Ã  jour. Beau travail.',
    todayAllCaughtUpDescription: 'Vous nâ€™avez aucune Ã©tape ni aucun workflow en attente.',
    todayAskArkosMission: 'Demander une nouvelle mission Ã  Arkos',
    todayClockNotStarted: 'Non pointÃ©',
    todayClockElapsedPrefix: 'Temps enregistrÃ©',
    todayClockInLabel: 'EntrÃ©e',
    todayClockCompleted: 'Session terminÃ©e',
    todayClockInAction: 'Pointer',
    todayClockOutAction: 'ArrÃªter',
    todayClockWorking: 'En cours',
    todayClockInError: 'Impossible de pointer.',
    todayClockOutError: 'Impossible dâ€™arrÃªter le suivi.',
  },
  de: {
    ...
    todayClockWorking: 'LÃ¤uft',
    todayClockInError: 'Einstempeln nicht mÃ¶glich.',
    todayClockOutError: 'Ausstempeln nicht mÃ¶glich.',
  },
  it: {
    ...
    todayAllCaughtUpTitle: 'Ãˆ tutto aggiornato. Ottimo lavoro.',
    ...
    todayClockInError: 'Impossibile timbrare lâ€™entrata.',
    todayClockOutError: 'Impossibile timbrare lâ€™uscita.',
  },
  nl: {
  ...
  pl: {
    todayGreetingMorning: 'DzieÅ„ dobry',
    todayGreetingAfternoon: 'DzieÅ„ dobry',
    todayGreetingEvening: 'Dobry wieczÃ³r',
    todayFallbackName: 'uÅ¼ytkownik',
    todayTimeTracking: 'Rejestracja czasu',
    todayViewHistory: 'Zobacz historiÄ™',
    todayAllCaughtUpTitle: 'Wszystko aktualne. Dobra robota.',
    todayAllCaughtUpDescription: 'Nie masz oczekujÄ…cych krokÃ³w ani przepÅ‚ywÃ³w.',
    todayAskArkosMission: 'PoproÅ› Arkos o nowÄ… misjÄ™',
    todayClockNotStarted: 'Nie rozpoczÄ™to pracy',
    todayClockElapsedPrefix: 'Zarejestrowany czas',
    todayClockInLabel: 'Start',
    todayClockCompleted: 'Sesja zakoÅ„czona',
    todayClockInAction: 'Rozpocznij',
    todayClockOutAction: 'ZakoÅ„cz',
    todayClockWorking: 'W toku',
    todayClockInError: 'Nie udaÅ‚o siÄ™ rozpoczÄ…Ä‡ pracy.',
    todayClockOutError: 'Nie udaÅ‚o siÄ™ zakoÅ„czyÄ‡ pracy.',
  },
  ro: {
    todayGreetingMorning: 'BunÄƒ dimineaÈ›a',
    todayGreetingAfternoon: 'BunÄƒ ziua',
    todayGreetingEvening: 'BunÄƒ seara',
    todayFallbackName: 'utilizator',
    todayTimeTracking: 'Pontaj',
    todayViewHistory: 'Vezi istoricul',
    todayAllCaughtUpTitle: 'Totul este la zi. BunÄƒ treabÄƒ.',
    todayAllCaughtUpDescription: 'Nu ai paÈ™i sau fluxuri Ã®n aÈ™teptare.',
    todayAskArkosMission: 'Cere-i lui Arkos o misiune nouÄƒ',
    todayClockNotStarted: 'Nepontat',
    todayClockElapsedPrefix: 'Timp Ã®nregistrat',
    todayClockInLabel: 'Intrare',
    todayClockCompleted: 'Sesiune finalizatÄƒ',
    todayClockInAction: 'PonteazÄƒ intrarea',
    todayClockOutAction: 'PonteazÄƒ ieÈ™irea',
    todayClockWorking: 'ÃŽn lucru',
    todayClockInError: 'Nu s-a putut ponta intrarea.',
    todayClockOutError: 'Nu s-a putut ponta ieÈ™irea.',
  },
  sv: {
    todayGreetingMorning: 'God morgon',
    todayGreetingAfternoon: 'God eftermiddag',
    todayGreetingEvening: 'God kvÃ¤ll',
    todayFallbackName: 'anvÃ¤ndare',
    todayTimeTracking: 'Tidsregistrering',
    todayViewHistory: 'Visa historik',
    todayAllCaughtUpTitle: 'Allt Ã¤r uppdaterat. Bra jobbat.',
    todayAllCaughtUpDescription: 'Du har inga vÃ¤ntande steg eller arbetsflÃ¶den.',
    todayAskArkosMission: 'Be Arkos om ett nytt uppdrag',
    todayClockNotStarted: 'Inte instÃ¤mplad',
    todayClockElapsedPrefix: 'Registrerad tid',
    todayClockInLabel: 'Start',
    todayClockCompleted: 'Pass slutfÃ¶rt',
    todayClockInAction: 'StÃ¤mpla in',
    todayClockOutAction: 'StÃ¤mpla ut',
    todayClockWorking: 'PÃ¥gÃ¥r',
    todayClockInError: 'Kunde inte stÃ¤mpla in.',
    todayClockOutError: 'Kunde inte stÃ¤mpla ut.',
  },
  da: {
  ...
  no: {
    ...
    todayClockInLabel: 'Start',
    todayClockCompleted: 'Ã˜kt fullfÃ¸rt',
  ...
  hu: {
    todayGreetingMorning: 'JÃ³ reggelt',
    todayGreetingAfternoon: 'JÃ³ napot',
    todayGreetingEvening: 'JÃ³ estÃ©t',
    todayFallbackName: 'felhasznÃ¡lÃ³',
    todayTimeTracking: 'IdÅ‘nyilvÃ¡ntartÃ¡s',
    todayViewHistory: 'ElÅ‘zmÃ©nyek megtekintÃ©se',
    todayAllCaughtUpTitle: 'Minden naprakÃ©sz. SzÃ©p munka.',
    todayAllCaughtUpDescription: 'Nincsenek fÃ¼ggÅ‘ben lÃ©vÅ‘ lÃ©pÃ©sek vagy munkafolyamatok.',
    todayAskArkosMission: 'KÃ©rj Ãºj kÃ¼ldetÃ©st ArkostÃ³l',
    todayClockNotStarted: 'Nincs bejelentkezve',
    todayClockElapsedPrefix: 'RÃ¶gzÃ­tett idÅ‘',
    todayClockInLabel: 'KezdÃ©s',
    todayClockCompleted: 'Munkamenet befejezve',
    todayClockInAction: 'BejelentkezÃ©s',
    todayClockOutAction: 'KijelentkezÃ©s',
    todayClockWorking: 'Folyamatban',
    todayClockInError: 'Nem sikerÃ¼lt bejelentkezni.',
    todayClockOutError: 'Nem sikerÃ¼lt kijelentkezni.',
  },
  cs: {
    todayGreetingMorning: 'DobrÃ© rÃ¡no',
    todayGreetingAfternoon: 'DobrÃ© odpoledne',
    todayGreetingEvening: 'DobrÃ½ veÄer',
    todayFallbackName: 'uÅ¾ivatel',
    todayTimeTracking: 'Evidence Äasu',
    todayViewHistory: 'Zobrazit historii',
    todayAllCaughtUpTitle: 'VÅ¡e je aktuÃ¡lnÃ­. DobrÃ¡ prÃ¡ce.',
    todayAllCaughtUpDescription: 'NemÃ¡te Å¾Ã¡dnÃ© ÄekajÃ­cÃ­ kroky ani pracovnÃ­ postupy.',
    todayAskArkosMission: 'PoÅ¾Ã¡dat Arkos o novou misi',
    todayClockNotStarted: 'NepÅ™ihlÃ¡Å¡eno',
    todayClockElapsedPrefix: 'ZaznamenanÃ½ Äas',
    todayClockInLabel: 'ZaÄÃ¡tek',
    todayClockCompleted: 'Relace dokonÄena',
    todayClockInAction: 'PÅ™ihlÃ¡sit pÅ™Ã­chod',
    todayClockOutAction: 'PÅ™ihlÃ¡sit odchod',
    todayClockWorking: 'ProbÃ­hÃ¡',
    todayClockInError: 'PÅ™Ã­chod se nepodaÅ™ilo zaznamenat.',
    todayClockOutError: 'Odchod se nepodaÅ™ilo zaznamenat.',
  },
  sk: {
    todayGreetingMorning: 'DobrÃ© rÃ¡no',
    todayGreetingAfternoon: 'DobrÃ© popoludnie',
    todayGreetingEvening: 'DobrÃ½ veÄer',
    todayFallbackName: 'pouÅ¾Ã­vateÄ¾',
    todayTimeTracking: 'Evidencia Äasu',
    todayViewHistory: 'ZobraziÅ¥ histÃ³riu',
    todayAllCaughtUpTitle: 'VÅ¡etko je aktuÃ¡lne. DobrÃ¡ prÃ¡ca.',
    todayAllCaughtUpDescription: 'NemÃ¡te Å¾iadne ÄakajÃºce kroky ani pracovnÃ© postupy.',
    todayAskArkosMission: 'PoÅ¾iadaÅ¥ Arkos o novÃº misiu',
    todayClockNotStarted: 'NeprihlÃ¡senÃ©',
    todayClockElapsedPrefix: 'ZaznamenanÃ½ Äas',
    todayClockInLabel: 'ZaÄiatok',
    todayClockCompleted: 'RelÃ¡cia dokonÄenÃ¡',
    todayClockInAction: 'ZaznamenaÅ¥ prÃ­chod',
    todayClockOutAction: 'ZaznamenaÅ¥ odchod',
    todayClockWorking: 'Prebieha',
    todayClockInError: 'PrÃ­chod sa nepodarilo zaznamenaÅ¥.',
    todayClockOutError: 'Odchod sa nepodarilo zaznamenaÅ¥.',
  },
  el: {
    todayGreetingMorning: 'ÎšÎ±Î»Î·Î¼Î­ÏÎ±',
    todayGreetingAfternoon: 'ÎšÎ±Î»ÏŒ Î±Ï€ÏŒÎ³ÎµÏ…Î¼Î±',
    todayGreetingEvening: 'ÎšÎ±Î»Î·ÏƒÏ€Î­ÏÎ±',
    todayFallbackName: 'Ï‡ÏÎ®ÏƒÏ„Î·Ï‚',
    todayTimeTracking: 'ÎšÎ±Ï„Î±Î³ÏÎ±Ï†Î® Ï‡ÏÏŒÎ½Î¿Ï…',
    todayViewHistory: 'Î ÏÎ¿Î²Î¿Î»Î® Î¹ÏƒÏ„Î¿ÏÎ¹ÎºÎ¿Ï',
    todayAllCaughtUpTitle: 'ÎŒÎ»Î± ÎµÎ¯Î½Î±Î¹ ÎµÎ½Î·Î¼ÎµÏÏ‰Î¼Î­Î½Î±. ÎšÎ±Î»Î® Î´Î¿Ï…Î»ÎµÎ¹Î¬.',
    todayAllCaughtUpDescription: 'Î”ÎµÎ½ Î­Ï‡ÎµÏ„Îµ ÎµÎºÎºÏÎµÎ¼Î® Î²Î®Î¼Î±Ï„Î± Î® ÏÎ¿Î­Ï‚ ÎµÏÎ³Î±ÏƒÎ¯Î±Ï‚.',
    todayAskArkosMission: 'Î–Î·Ï„Î®ÏƒÏ„Îµ Î½Î­Î± Î±Ï€Î¿ÏƒÏ„Î¿Î»Î® Î±Ï€ÏŒ Ï„Î¿ Arkos',
    todayClockNotStarted: 'Î”ÎµÎ½ Î­Ï‡ÎµÎ¹ Î³Î¯Î½ÎµÎ¹ Î­Î½Î±ÏÎ¾Î·',
    todayClockElapsedPrefix: 'ÎšÎ±Ï„Î±Î³ÎµÎ³ÏÎ±Î¼Î¼Î­Î½Î¿Ï‚ Ï‡ÏÏŒÎ½Î¿Ï‚',
    todayClockInLabel: 'ÎˆÎ½Î±ÏÎ¾Î·',
    todayClockCompleted: 'Î— ÏƒÏ…Î½ÎµÎ´ÏÎ¯Î± Î¿Î»Î¿ÎºÎ»Î·ÏÏŽÎ¸Î·ÎºÎµ',
    todayClockInAction: 'ÎˆÎ½Î±ÏÎ¾Î· Ï‡ÏÏŒÎ½Î¿Ï…',
    todayClockOutAction: 'Î›Î®Î¾Î· Ï‡ÏÏŒÎ½Î¿Ï…',
    todayClockWorking: 'Î£Îµ ÎµÎ¾Î­Î»Î¹Î¾Î·',
    todayClockInError: 'Î”ÎµÎ½ Î®Ï„Î±Î½ Î´Ï…Î½Î±Ï„Î® Î· Î­Î½Î±ÏÎ¾Î· Ï‡ÏÏŒÎ½Î¿Ï….',
    todayClockOutError: 'Î”ÎµÎ½ Î®Ï„Î±Î½ Î´Ï…Î½Î±Ï„Î® Î· Î»Î®Î¾Î· Ï‡ÏÏŒÎ½Î¿Ï….',
  },
  fi: {
    todayGreetingMorning: 'HyvÃ¤Ã¤ huomenta',
    todayGreetingAfternoon: 'HyvÃ¤Ã¤ iltapÃ¤ivÃ¤Ã¤',
    todayGreetingEvening: 'HyvÃ¤Ã¤ iltaa',
    todayFallbackName: 'kÃ¤yttÃ¤jÃ¤',
    todayTimeTracking: 'TyÃ¶ajan seuranta',
    todayViewHistory: 'NÃ¤ytÃ¤ historia',
    todayAllCaughtUpTitle: 'Kaikki on ajan tasalla. HyvÃ¤Ã¤ tyÃ¶tÃ¤.',
    todayAllCaughtUpDescription: 'Sinulla ei ole odottavia vaiheita tai tyÃ¶nkulkuja.',
    todayAskArkosMission: 'PyydÃ¤ Arkosilta uusi tehtÃ¤vÃ¤',
    todayClockNotStarted: 'Ei kirjautunut sisÃ¤Ã¤n',
    todayClockElapsedPrefix: 'Kirjattu aika',
    todayClockInLabel: 'Aloitus',
    todayClockCompleted: 'Istunto valmis',
    todayClockInAction: 'Kirjaudu sisÃ¤Ã¤n',
    todayClockOutAction: 'Kirjaudu ulos',
    todayClockWorking: 'KÃ¤ynnissÃ¤',
    todayClockInError: 'SisÃ¤Ã¤nkirjaus epÃ¤onnistui.',
    todayClockOutError: 'Uloskirjaus epÃ¤onnistui.',
  },
  hr: {
    todayGreetingMorning: 'Dobro jutro',
    todayGreetingAfternoon: 'Dobar dan',
    todayGreetingEvening: 'Dobra veÄer',
    todayFallbackName: 'korisnik',
    todayTimeTracking: 'PraÄ‡enje vremena',
    todayViewHistory: 'PrikaÅ¾i povijest',
    todayAllCaughtUpTitle: 'Sve je aÅ¾urno. Dobar posao.',
    todayAllCaughtUpDescription: 'Nemate koraka ni tijekova rada na Äekanju.',
    todayAskArkosMission: 'ZatraÅ¾i novu misiju od Arkosa',
    todayClockNotStarted: 'Nije prijavljeno',
    todayClockElapsedPrefix: 'ZabiljeÅ¾eno vrijeme',
    todayClockInLabel: 'PoÄetak',
    todayClockCompleted: 'Sesija dovrÅ¡ena',
    todayClockInAction: 'Prijavi poÄetak',
    todayClockOutAction: 'Prijavi kraj',
    todayClockWorking: 'U tijeku',
    todayClockInError: 'Nije moguÄ‡e prijaviti poÄetak.',
    todayClockOutError: 'Nije moguÄ‡e prijaviti kraj.',
  },
  bg: {
    todayGreetingMorning: 'Ð”Ð¾Ð±Ñ€Ð¾ ÑƒÑ‚Ñ€Ð¾',
    todayGreetingAfternoon: 'Ð”Ð¾Ð±ÑŠÑ€ Ð´ÐµÐ½',
    todayGreetingEvening: 'Ð”Ð¾Ð±ÑŠÑ€ Ð²ÐµÑ‡ÐµÑ€',
    todayFallbackName: 'Ð¿Ð¾Ñ‚Ñ€ÐµÐ±Ð¸Ñ‚ÐµÐ»',
    todayTimeTracking: 'ÐžÑ‚Ñ‡Ð¸Ñ‚Ð°Ð½Ðµ Ð½Ð° Ð²Ñ€ÐµÐ¼Ðµ',
    todayViewHistory: 'Ð’Ð¸Ð¶ Ð¸ÑÑ‚Ð¾Ñ€Ð¸Ñ',
    todayAllCaughtUpTitle: 'Ð’ÑÐ¸Ñ‡ÐºÐ¾ Ðµ Ð°ÐºÑ‚ÑƒÐ°Ð»Ð½Ð¾. Ð”Ð¾Ð±Ñ€Ð° Ñ€Ð°Ð±Ð¾Ñ‚Ð°.',
    todayAllCaughtUpDescription: 'ÐÑÐ¼Ð°Ñ‚Ðµ Ñ‡Ð°ÐºÐ°Ñ‰Ð¸ ÑÑ‚ÑŠÐ¿ÐºÐ¸ Ð¸Ð»Ð¸ Ñ€Ð°Ð±Ð¾Ñ‚Ð½Ð¸ Ð¿Ð¾Ñ‚Ð¾Ñ†Ð¸.',
    todayAskArkosMission: 'ÐŸÐ¾Ð¼Ð¾Ð»ÐµÑ‚Ðµ Arkos Ð·Ð° Ð½Ð¾Ð²Ð° Ð¼Ð¸ÑÐ¸Ñ',
    todayClockNotStarted: 'ÐÐµ Ðµ ÑÑ‚Ð°Ñ€Ñ‚Ð¸Ñ€Ð°Ð½Ð¾',
    todayClockElapsedPrefix: 'ÐžÑ‚Ñ‡ÐµÑ‚ÐµÐ½Ð¾ Ð²Ñ€ÐµÐ¼Ðµ',
    todayClockInLabel: 'ÐÐ°Ñ‡Ð°Ð»Ð¾',
    todayClockCompleted: 'Ð¡ÐµÑÐ¸ÑÑ‚Ð° Ðµ Ð·Ð°Ð²ÑŠÑ€ÑˆÐµÐ½Ð°',
    todayClockInAction: 'Ð—Ð°Ð¿Ð¾Ñ‡Ð½Ð¸ Ð¾Ñ‚Ñ‡Ð¸Ñ‚Ð°Ð½Ðµ',
    todayClockOutAction: 'Ð¡Ð¿Ñ€Ð¸ Ð¾Ñ‚Ñ‡Ð¸Ñ‚Ð°Ð½Ðµ',
    todayClockWorking: 'Ð’ Ñ…Ð¾Ð´',
    todayClockInError: 'ÐÐµÑƒÑÐ¿ÐµÑˆÐ½Ð¾ ÑÑ‚Ð°Ñ€Ñ‚Ð¸Ñ€Ð°Ð½Ðµ Ð½Ð° Ð¾Ñ‚Ñ‡Ð¸Ñ‚Ð°Ð½ÐµÑ‚Ð¾.',
    todayClockOutError: 'ÐÐµÑƒÑÐ¿ÐµÑˆÐ½Ð¾ ÑÐ¿Ð¸Ñ€Ð°Ð½Ðµ Ð½Ð° Ð¾Ñ‚Ñ‡Ð¸Ñ‚Ð°Ð½ÐµÑ‚Ð¾.',
  },
  sl: {
    todayGreetingMorning: 'Dobro jutro',
    todayGreetingAfternoon: 'Dober dan',
    todayGreetingEvening: 'Dober veÄer',
    todayFallbackName: 'uporabnik',
    todayTimeTracking: 'Sledenje Äasu',
    todayViewHistory: 'PrikaÅ¾i zgodovino',
    todayAllCaughtUpTitle: 'Vse je posodobljeno. Dobro opravljeno.',
    todayAllCaughtUpDescription: 'Nimate ÄakajoÄih korakov ali delovnih tokov.',
    todayAskArkosMission: 'Prosite Arkos za novo misijo',
    todayClockNotStarted: 'Ni prijavljeno',
    todayClockElapsedPrefix: 'ZabeleÅ¾en Äas',
    todayClockInLabel: 'ZaÄetek',
    todayClockCompleted: 'Seja zakljuÄena',
    todayClockInAction: 'Prijavi zaÄetek',
    todayClockOutAction: 'Prijavi konec',
    todayClockWorking: 'V teku',
    todayClockInError: 'ZaÄetka ni bilo mogoÄe prijaviti.',
    todayClockOutError: 'Konca ni bilo mogoÄe prijaviti.',
  },
  ja: {
    todayGreetingMorning: 'ãŠã¯ã‚ˆã†ã”ã–ã„ã¾ã™',
    todayGreetingAfternoon: 'ã“ã‚“ã«ã¡ã¯',
    todayGreetingEvening: 'ã“ã‚“ã°ã‚“ã¯',
    todayFallbackName: 'ãƒ¦ãƒ¼ã‚¶ãƒ¼',
    todayTimeTracking: 'æ™‚é–“è¨˜éŒ²',
    todayViewHistory: 'å±¥æ­´ã‚’è¦‹ã‚‹',
    todayAllCaughtUpTitle: 'ã™ã¹ã¦æœ€æ–°ã§ã™ã€‚ã‚ˆãã§ãã¾ã—ãŸã€‚',
    todayAllCaughtUpDescription: 'ä¿ç•™ä¸­ã®ã‚¹ãƒ†ãƒƒãƒ—ã‚„ãƒ¯ãƒ¼ã‚¯ãƒ•ãƒ­ãƒ¼ã¯ã‚ã‚Šã¾ã›ã‚“ã€‚',
    todayAskArkosMission: 'Arkos ã«æ–°ã—ã„ãƒŸãƒƒã‚·ãƒ§ãƒ³ã‚’ä¾é ¼',
    todayClockNotStarted: 'æœªé–‹å§‹',
    todayClockElapsedPrefix: 'è¨˜éŒ²æ¸ˆã¿æ™‚é–“',
    todayClockInLabel: 'é–‹å§‹',
    todayClockCompleted: 'ã‚»ãƒƒã‚·ãƒ§ãƒ³å®Œäº†',
    todayClockInAction: 'é–‹å§‹ã™ã‚‹',
    todayClockOutAction: 'çµ‚äº†ã™ã‚‹',
    todayClockWorking: 'ä½œæ¥­ä¸­',
    todayClockInError: 'é–‹å§‹ã‚’è¨˜éŒ²ã§ãã¾ã›ã‚“ã§ã—ãŸã€‚',
    todayClockOutError: 'çµ‚äº†ã‚’è¨˜éŒ²ã§ãã¾ã›ã‚“ã§ã—ãŸã€‚',
  },
  zh: {
    todayGreetingMorning: 'æ—©ä¸Šå¥½',
    todayGreetingAfternoon: 'ä¸‹åˆå¥½',
    todayGreetingEvening: 'æ™šä¸Šå¥½',
    todayFallbackName: 'ç”¨æˆ·',
    todayTimeTracking: 'æ—¶é—´è®°å½•',
    todayViewHistory: 'æŸ¥çœ‹åŽ†å²',
    todayAllCaughtUpTitle: 'ä¸€åˆ‡éƒ½æ˜¯æœ€æ–°çš„ã€‚åšå¾—å¥½ã€‚',
    todayAllCaughtUpDescription: 'æ²¡æœ‰å¾…å¤„ç†çš„æ­¥éª¤æˆ–å·¥ä½œæµã€‚',
    todayAskArkosMission: 'è®© Arkos åˆ›å»ºæ–°ä»»åŠ¡',
    todayClockNotStarted: 'å°šæœªæ‰“å¡',
    todayClockElapsedPrefix: 'å·²è®°å½•æ—¶é—´',
    todayClockInLabel: 'å¼€å§‹',
    todayClockCompleted: 'ä¼šè¯å·²å®Œæˆ',
    todayClockInAction: 'æ‰“å¡å¼€å§‹',
    todayClockOutAction: 'æ‰“å¡ç»“æŸ',
    todayClockWorking: 'è¿›è¡Œä¸­',
    todayClockInError: 'æ— æ³•æ‰“å¡å¼€å§‹ã€‚',
    todayClockOutError: 'æ— æ³•æ‰“å¡ç»“æŸã€‚',
  },
}

const toolsLocaleOverrides: Partial<Record<Locale, Partial<DashboardTranslations>>> = {
  fr: {
    toolsInstalledTitle: 'Outils installÃ©s',
    toolsInstalledDescription: 'Les outils que vous utilisez dans ce workspace.',
    toolsGenerate: 'GÃ©nÃ©rer',
    toolsAdd: 'Ajouter',
    toolsActive: 'actifs',
    toolsOpen: 'Ouvrir',
    toolsEmptyTitle: 'Installez votre premier outil',
    toolsEmptyDescription: 'CrÃ©ez un outil avec lâ€™IA ou choisissez-en un dans le catalogue.',
    toolNewEntry: 'Nouvelle entrÃ©e',
    toolAiIdeas: 'IdÃ©es IA',
    ...
    toolForm: 'Formulaire',
    toolRun: 'ExÃ©cuter',
    toolGenerating: 'GÃ©nÃ©ration...',
    toolHistoryTitle: 'Historique des exÃ©cutions IA',
    toolRunNow: 'ExÃ©cuter maintenant',
  },
  de: {
    ...
    toolsAdd: 'HinzufÃ¼gen',
    toolsActive: 'aktiv',
    toolsOpen: 'Ã–ffnen',
    toolsEmptyTitle: 'Installieren Sie Ihr erstes Tool',
    toolsEmptyDescription: 'Erstellen Sie ein Tool mit KI oder wÃ¤hlen Sie eines aus dem Katalog.',
    toolNewEntry: 'Neuer Eintrag',
    toolAiIdeas: 'KI-Ideen',
    toolImportCsv: 'CSV importieren',
    toolNoRecords: 'Noch keine EintrÃ¤ge in diesem Tool.',
    toolType: 'Typ',
    toolDate: 'Datum',
    ...
    toolHistoryTitle: 'KI-AusfÃ¼hrungsverlauf',
    toolRunNow: 'Jetzt ausfÃ¼hren',
  },
  pt: {
    ...
    toolsEmptyDescription: 'Crie uma ferramenta com IA ou escolha uma do catÃ¡logo.',
    toolNewEntry: 'Nova entrada',
    toolAiIdeas: 'Ideias IA',
    toolImportCsv: 'Importar CSV',
    toolNoRecords: 'Ainda nÃ£o hÃ¡ registos nesta ferramenta.',
    toolType: 'Tipo',
    toolDate: 'Data',
    toolActions: 'AÃ§Ãµes',
    toolForm: 'FormulÃ¡rio',
    toolRun: 'Executar',
    toolGenerating: 'A gerar...',
    toolHistoryTitle: 'HistÃ³rico de execuÃ§Ãµes IA',
  ...
  it: {
    ...
    toolsEmptyDescription: 'Crea uno strumento con lâ€™IA o scegline uno dal catalogo.',
  ...
  nl: {
    toolsInstalledTitle: 'GeÃ¯nstalleerde tools',
  ...
  pl: {
    toolsInstalledTitle: 'Zainstalowane narzÄ™dzia',
    toolsInstalledDescription: 'NarzÄ™dzia uÅ¼ywane w tym workspace.',
    toolsGenerate: 'Generuj',
    toolsAdd: 'Dodaj',
    toolsActive: 'aktywne',
    toolsOpen: 'OtwÃ³rz',
    toolsEmptyTitle: 'Zainstaluj pierwsze narzÄ™dzie',
    toolsEmptyDescription: 'UtwÃ³rz narzÄ™dzie z AI albo wybierz je z katalogu.',
    toolNewEntry: 'Nowy wpis',
    toolAiIdeas: 'PomysÅ‚y AI',
    toolImportCsv: 'Importuj CSV',
    toolNoRecords: 'To narzÄ™dzie nie ma jeszcze rekordÃ³w.',
    toolType: 'Typ',
    toolDate: 'Data',
    toolActions: 'Akcje',
    toolForm: 'Formularz',
    ...
    toolHistoryTitle: 'Historia uruchomieÅ„ AI',
    toolRunNow: 'Uruchom teraz',
  },
  ro: {
    toolsInstalledTitle: 'Instrumente instalate',
    toolsInstalledDescription: 'Instrumentele pe care le foloseÈ™ti Ã®n acest workspace.',
    toolsGenerate: 'GenereazÄƒ',
    toolsAdd: 'AdaugÄƒ',
    toolsActive: 'active',
    toolsOpen: 'Deschide',
    toolsEmptyTitle: 'InstaleazÄƒ primul instrument',
    toolsEmptyDescription: 'CreeazÄƒ un instrument cu IA sau alege unul din catalog.',
    toolNewEntry: 'Intrare nouÄƒ',
    toolAiIdeas: 'Idei IA',
    toolImportCsv: 'ImportÄƒ CSV',
    toolNoRecords: 'Nu existÄƒ Ã®ncÄƒ Ã®nregistrÄƒri Ã®n acest instrument.',
    toolType: 'Tip',
    toolDate: 'DatÄƒ',
    toolActions: 'AcÈ›iuni',
    toolForm: 'Formular',
    toolRun: 'ExecutÄƒ',
    toolGenerating: 'Se genereazÄƒ...',
    toolHistoryTitle: 'Istoric execuÈ›ii IA',
    toolRunNow: 'ExecutÄƒ acum',
  },
  sv: {
    toolsInstalledTitle: 'Installerade verktyg',
    toolsInstalledDescription: 'Verktygen du anvÃ¤nder i denna workspace.',
    toolsGenerate: 'Generera',
    toolsAdd: 'LÃ¤gg till',
    toolsActive: 'aktiva',
    toolsOpen: 'Ã–ppna',
    toolsEmptyTitle: 'Installera ditt fÃ¶rsta verktyg',
    toolsEmptyDescription: 'Skapa ett verktyg med AI eller vÃ¤lj ett frÃ¥n katalogen.',
    toolNewEntry: 'Ny post',
    toolAiIdeas: 'AI-idÃ©er',
    toolImportCsv: 'Importera CSV',
    toolNoRecords: 'Det finns inga poster i detta verktyg Ã¤n.',
    toolType: 'Typ',
    toolDate: 'Datum',
    toolActions: 'Ã…tgÃ¤rder',
    toolForm: 'FormulÃ¤r',
    toolRun: 'KÃ¶r',
    toolGenerating: 'Genererar...',
    toolHistoryTitle: 'AI-kÃ¶rningshistorik',
    toolRunNow: 'KÃ¶r nu',
  },
  da: {
    toolsInstalledTitle: 'Installerede vÃ¦rktÃ¸jer',
    toolsInstalledDescription: 'De vÃ¦rktÃ¸jer du bruger i dette workspace.',
    toolsGenerate: 'GenerÃ©r',
    toolsAdd: 'TilfÃ¸j',
    toolsActive: 'aktive',
    toolsOpen: 'Ã…bn',
    toolsEmptyTitle: 'Installer dit fÃ¸rste vÃ¦rktÃ¸j',
    toolsEmptyDescription: 'Opret et vÃ¦rktÃ¸j med AI eller vÃ¦lg et fra kataloget.',
    toolNewEntry: 'Ny post',
    toolAiIdeas: 'AI-idÃ©er',
    toolImportCsv: 'ImportÃ©r CSV',
    toolNoRecords: 'Der er endnu ingen poster i dette vÃ¦rktÃ¸j.',
    toolType: 'Type',
    toolDate: 'Dato',
    ...
    toolHistoryTitle: 'AI-kÃ¸rselshistorik',
    toolRunNow: 'KÃ¸r nu',
  },
  no: {
    toolsInstalledTitle: 'Installerte verktÃ¸y',
    toolsInstalledDescription: 'VerktÃ¸yene du bruker i denne workspacen.',
    toolsGenerate: 'Generer',
    toolsAdd: 'Legg til',
    toolsActive: 'aktive',
    toolsOpen: 'Ã…pne',
    toolsEmptyTitle: 'Installer ditt fÃ¸rste verktÃ¸y',
    toolsEmptyDescription: 'Lag et verktÃ¸y med AI eller velg et fra katalogen.',
    toolNewEntry: 'Ny oppfÃ¸ring',
    toolAiIdeas: 'AI-ideer',
    toolImportCsv: 'Importer CSV',
    toolNoRecords: 'Det finnes ingen oppfÃ¸ringer i dette verktÃ¸yet ennÃ¥.',
    toolType: 'Type',
    toolDate: 'Dato',
    toolActions: 'Handlinger',
    toolForm: 'Skjema',
    toolRun: 'KjÃ¸r',
    toolGenerating: 'Genererer...',
    toolHistoryTitle: 'AI-kjÃ¸ringshistorikk',
    toolRunNow: 'KjÃ¸r nÃ¥',
  },
  hu: {
    toolsInstalledTitle: 'TelepÃ­tett eszkÃ¶zÃ¶k',
    toolsInstalledDescription: 'Az ebben a workspace-ben hasznÃ¡lt eszkÃ¶zÃ¶k.',
    toolsGenerate: 'GenerÃ¡lÃ¡s',
    toolsAdd: 'HozzÃ¡adÃ¡s',
    toolsActive: 'aktÃ­v',
    toolsOpen: 'MegnyitÃ¡s',
    toolsEmptyTitle: 'TelepÃ­tse az elsÅ‘ eszkÃ¶zt',
    toolsEmptyDescription: 'Hozzon lÃ©tre eszkÃ¶zt AI-val, vagy vÃ¡lasszon egyet a katalÃ³gusbÃ³l.',
    toolNewEntry: 'Ãšj bejegyzÃ©s',
    toolAiIdeas: 'AI-Ã¶tletek',
    toolImportCsv: 'CSV importÃ¡lÃ¡sa',
    toolNoRecords: 'Ebben az eszkÃ¶zben mÃ©g nincsenek rekordok.',
    toolType: 'TÃ­pus',
    toolDate: 'DÃ¡tum',
    toolActions: 'MÅ±veletek',
    toolForm: 'Å°rlap',
    toolRun: 'FuttatÃ¡s',
    toolGenerating: 'GenerÃ¡lÃ¡s...',
    toolHistoryTitle: 'AI futtatÃ¡si elÅ‘zmÃ©nyek',
    toolRunNow: 'FuttatÃ¡s most',
  },
  cs: {
    toolsInstalledTitle: 'NainstalovanÃ© nÃ¡stroje',
    toolsInstalledDescription: 'NÃ¡stroje, kterÃ© pouÅ¾Ã­vÃ¡te v tomto workspace.',
    toolsGenerate: 'Generovat',
    toolsAdd: 'PÅ™idat',
    toolsActive: 'aktivnÃ­',
    toolsOpen: 'OtevÅ™Ã­t',
    toolsEmptyTitle: 'Nainstalujte prvnÃ­ nÃ¡stroj',
    toolsEmptyDescription: 'VytvoÅ™te nÃ¡stroj pomocÃ­ AI nebo vyberte jeden z katalogu.',
    toolNewEntry: 'NovÃ½ zÃ¡znam',
    toolAiIdeas: 'NÃ¡pady AI',
    toolImportCsv: 'Importovat CSV',
    toolNoRecords: 'V tomto nÃ¡stroji zatÃ­m nejsou Å¾Ã¡dnÃ© zÃ¡znamy.',
    toolType: 'Typ',
    toolDate: 'Datum',
    toolActions: 'Akce',
    toolForm: 'FormulÃ¡Å™',
    ...
    toolHistoryTitle: 'Historie spuÅ¡tÄ›nÃ­ AI',
    toolRunNow: 'Spustit nynÃ­',
  },
  sk: {
    toolsInstalledTitle: 'NainÅ¡talovanÃ© nÃ¡stroje',
    toolsInstalledDescription: 'NÃ¡stroje, ktorÃ© pouÅ¾Ã­vate v tomto workspace.',
    toolsGenerate: 'GenerovaÅ¥',
    toolsAdd: 'PridaÅ¥',
    toolsActive: 'aktÃ­vne',
    toolsOpen: 'OtvoriÅ¥',
    toolsEmptyTitle: 'NainÅ¡talujte prvÃ½ nÃ¡stroj',
    toolsEmptyDescription: 'Vytvorte nÃ¡stroj pomocou AI alebo vyberte jeden z katalÃ³gu.',
    toolNewEntry: 'NovÃ½ zÃ¡znam',
    toolAiIdeas: 'NÃ¡pady AI',
    toolImportCsv: 'ImportovaÅ¥ CSV',
    toolNoRecords: 'V tomto nÃ¡stroji zatiaÄ¾ nie sÃº Å¾iadne zÃ¡znamy.',
    toolType: 'Typ',
    toolDate: 'DÃ¡tum',
    toolActions: 'Akcie',
    toolForm: 'FormulÃ¡r',
    ...
    toolHistoryTitle: 'HistÃ³ria spustenÃ­ AI',
    toolRunNow: 'SpustiÅ¥ teraz',
  },
  el: {
    toolsInstalledTitle: 'Î•Î³ÎºÎ±Ï„ÎµÏƒÏ„Î·Î¼Î­Î½Î± ÎµÏÎ³Î±Î»ÎµÎ¯Î±',
    toolsInstalledDescription: 'Î¤Î± ÎµÏÎ³Î±Î»ÎµÎ¯Î± Ï€Î¿Ï… Ï‡ÏÎ·ÏƒÎ¹Î¼Î¿Ï€Î¿Î¹ÎµÎ¯Ï„Îµ ÏƒÎµ Î±Ï…Ï„ÏŒ Ï„Î¿ workspace.',
    toolsGenerate: 'Î”Î·Î¼Î¹Î¿Ï…ÏÎ³Î¯Î±',
    toolsAdd: 'Î ÏÎ¿ÏƒÎ¸Î®ÎºÎ·',
    toolsActive: 'ÎµÎ½ÎµÏÎ³Î¬',
    toolsOpen: 'Î†Î½Î¿Î¹Î³Î¼Î±',
    toolsEmptyTitle: 'Î•Î³ÎºÎ±Ï„Î±ÏƒÏ„Î®ÏƒÏ„Îµ Ï„Î¿ Ï€ÏÏŽÏ„Î¿ ÏƒÎ±Ï‚ ÎµÏÎ³Î±Î»ÎµÎ¯Î¿',
    toolsEmptyDescription: 'Î”Î·Î¼Î¹Î¿Ï…ÏÎ³Î®ÏƒÏ„Îµ Î­Î½Î± ÎµÏÎ³Î±Î»ÎµÎ¯Î¿ Î¼Îµ AI Î® ÎµÏ€Î¹Î»Î­Î¾Ï„Îµ Î­Î½Î± Î±Ï€ÏŒ Ï„Î¿Î½ ÎºÎ±Ï„Î¬Î»Î¿Î³Î¿.',
    toolNewEntry: 'ÎÎ­Î± ÎµÎ³Î³ÏÎ±Ï†Î®',
    toolAiIdeas: 'Î™Î´Î­ÎµÏ‚ AI',
    toolImportCsv: 'Î•Î¹ÏƒÎ±Î³Ï‰Î³Î® CSV',
    toolNoRecords: 'Î”ÎµÎ½ Ï…Ï€Î¬ÏÏ‡Î¿Ï…Î½ Î±ÎºÏŒÎ¼Î· ÎµÎ³Î³ÏÎ±Ï†Î­Ï‚ ÏƒÎµ Î±Ï…Ï„ÏŒ Ï„Î¿ ÎµÏÎ³Î±Î»ÎµÎ¯Î¿.',
    toolType: 'Î¤ÏÏ€Î¿Ï‚',
    toolDate: 'Î—Î¼ÎµÏÎ¿Î¼Î·Î½Î¯Î±',
    toolActions: 'Î•Î½Î­ÏÎ³ÎµÎ¹ÎµÏ‚',
    toolForm: 'Î¦ÏŒÏÎ¼Î±',
    toolRun: 'Î•ÎºÏ„Î­Î»ÎµÏƒÎ·',
    toolGenerating: 'Î”Î·Î¼Î¹Î¿Ï…ÏÎ³Î¯Î±...',
    toolHistoryTitle: 'Î™ÏƒÏ„Î¿ÏÎ¹ÎºÏŒ ÎµÎºÏ„ÎµÎ»Î­ÏƒÎµÏ‰Î½ AI',
    toolRunNow: 'Î•ÎºÏ„Î­Î»ÎµÏƒÎ· Ï„ÏŽÏÎ±',
  },
  fi: {
    toolsInstalledTitle: 'Asennetut tyÃ¶kalut',
    toolsInstalledDescription: 'TyÃ¶kalut, joita kÃ¤ytÃ¤t tÃ¤ssÃ¤ workspace-tilassa.',
    toolsGenerate: 'Luo',
    toolsAdd: 'LisÃ¤Ã¤',
    toolsActive: 'aktiivista',
    toolsOpen: 'Avaa',
    toolsEmptyTitle: 'Asenna ensimmÃ¤inen tyÃ¶kalusi',
    toolsEmptyDescription: 'Luo tyÃ¶kalu AI:lla tai valitse yksi katalogista.',
    toolNewEntry: 'Uusi merkintÃ¤',
    toolAiIdeas: 'AI-ideat',
    toolImportCsv: 'Tuo CSV',
    toolNoRecords: 'TÃ¤ssÃ¤ tyÃ¶kalussa ei ole vielÃ¤ merkintÃ¶jÃ¤.',
    toolType: 'Tyyppi',
    toolDate: 'PÃ¤ivÃ¤mÃ¤Ã¤rÃ¤',
  ...
  hr: {
    ...
    toolsEmptyDescription: 'Izradite alat pomoÄ‡u AI-ja ili odaberite jedan iz kataloga.',
    toolNewEntry: 'Novi zapis',
    toolAiIdeas: 'AI ideje',
    toolImportCsv: 'Uvezi CSV',
    toolNoRecords: 'JoÅ¡ nema zapisa u ovom alatu.',
    toolType: 'Tip',
    toolDate: 'Datum',
    toolActions: 'Radnje',
    toolForm: 'Obrazac',
    ...
    toolHistoryTitle: 'Povijest AI izvrÅ¡avanja',
    toolRunNow: 'Pokreni sada',
  },
  bg: {
    toolsInstalledTitle: 'Ð˜Ð½ÑÑ‚Ð°Ð»Ð¸Ñ€Ð°Ð½Ð¸ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚Ð¸',
    toolsInstalledDescription: 'Ð˜Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚Ð¸Ñ‚Ðµ, ÐºÐ¾Ð¸Ñ‚Ð¾ Ð¸Ð·Ð¿Ð¾Ð»Ð·Ð²Ð°Ñ‚Ðµ Ð² Ñ‚Ð¾Ð·Ð¸ workspace.',
    toolsGenerate: 'Ð“ÐµÐ½ÐµÑ€Ð¸Ñ€Ð°Ð¹',
    toolsAdd: 'Ð”Ð¾Ð±Ð°Ð²Ð¸',
    toolsActive: 'Ð°ÐºÑ‚Ð¸Ð²Ð½Ð¸',
    toolsOpen: 'ÐžÑ‚Ð²Ð¾Ñ€Ð¸',
    toolsEmptyTitle: 'Ð˜Ð½ÑÑ‚Ð°Ð»Ð¸Ñ€Ð°Ð¹Ñ‚Ðµ Ð¿ÑŠÑ€Ð²Ð¸Ñ ÑÐ¸ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚',
    toolsEmptyDescription: 'Ð¡ÑŠÐ·Ð´Ð°Ð¹Ñ‚Ðµ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚ Ñ AI Ð¸Ð»Ð¸ Ð¸Ð·Ð±ÐµÑ€ÐµÑ‚Ðµ ÐµÐ´Ð¸Ð½ Ð¾Ñ‚ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð°.',
    toolNewEntry: 'ÐÐ¾Ð² Ð·Ð°Ð¿Ð¸Ñ',
    toolAiIdeas: 'AI Ð¸Ð´ÐµÐ¸',
    toolImportCsv: 'Ð˜Ð¼Ð¿Ð¾Ñ€Ñ‚Ð¸Ñ€Ð°Ð¹ CSV',
    toolNoRecords: 'Ð’ÑÐµ Ð¾Ñ‰Ðµ Ð½ÑÐ¼Ð° Ð·Ð°Ð¿Ð¸ÑÐ¸ Ð² Ñ‚Ð¾Ð·Ð¸ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐ¼ÐµÐ½Ñ‚.',
    toolType: 'Ð¢Ð¸Ð¿',
    toolDate: 'Ð”Ð°Ñ‚Ð°',
    toolActions: 'Ð”ÐµÐ¹ÑÑ‚Ð²Ð¸Ñ',
    toolForm: 'Ð¤Ð¾Ñ€Ð¼ÑƒÐ»ÑÑ€',
    toolRun: 'Ð˜Ð·Ð¿ÑŠÐ»Ð½Ð¸',
    toolGenerating: 'Ð“ÐµÐ½ÐµÑ€Ð¸Ñ€Ð°Ð½Ðµ...',
    toolHistoryTitle: 'Ð˜ÑÑ‚Ð¾Ñ€Ð¸Ñ Ð½Ð° AI Ð¸Ð·Ð¿ÑŠÐ»Ð½ÐµÐ½Ð¸ÑÑ‚Ð°',
    toolRunNow: 'Ð˜Ð·Ð¿ÑŠÐ»Ð½Ð¸ ÑÐµÐ³Ð°',
  },
  sl: {
    toolsInstalledTitle: 'NameÅ¡Äena orodja',
    ...
    toolNoRecords: 'V tem orodju Å¡e ni zapisov.',
    toolType: 'Vrsta',
    toolDate: 'Datum',
    toolActions: 'Dejanja',
    toolForm: 'Obrazec',
    ...
    toolRunNow: 'ZaÅ¾eni zdaj',
  },
  ja: {
    toolsInstalledTitle: 'ã‚¤ãƒ³ã‚¹ãƒˆãƒ¼ãƒ«æ¸ˆã¿ãƒ„ãƒ¼ãƒ«',
    toolsInstalledDescription: 'ã“ã® workspace ã§ä½¿ç”¨ã—ã¦ã„ã‚‹ãƒ„ãƒ¼ãƒ«ã§ã™ã€‚',
    toolsGenerate: 'ç”Ÿæˆ',
    toolsAdd: 'è¿½åŠ ',
    toolsActive: 'æœ‰åŠ¹',
    toolsOpen: 'é–‹ã',
    toolsEmptyTitle: 'æœ€åˆã®ãƒ„ãƒ¼ãƒ«ã‚’ã‚¤ãƒ³ã‚¹ãƒˆãƒ¼ãƒ«',
    toolsEmptyDescription: 'AIã§ãƒ„ãƒ¼ãƒ«ã‚’ä½œæˆã™ã‚‹ã‹ã€ã‚«ã‚¿ãƒ­ã‚°ã‹ã‚‰é¸æŠžã—ã¦ãã ã•ã„ã€‚',
    toolNewEntry: 'æ–°ã—ã„ãƒ¬ã‚³ãƒ¼ãƒ‰',
    toolAiIdeas: 'AIã‚¢ã‚¤ãƒ‡ã‚¢',
    toolImportCsv: 'CSVã‚’ã‚¤ãƒ³ãƒãƒ¼ãƒˆ',
    toolNoRecords: 'ã“ã®ãƒ„ãƒ¼ãƒ«ã«ã¯ã¾ã ãƒ¬ã‚³ãƒ¼ãƒ‰ãŒã‚ã‚Šã¾ã›ã‚“ã€‚',
    toolType: 'ã‚¿ã‚¤ãƒ—',
    toolDate: 'æ—¥ä»˜',
    toolActions: 'æ“ä½œ',
    toolForm: 'ãƒ•ã‚©ãƒ¼ãƒ ',
    toolRun: 'å®Ÿè¡Œ',
    toolGenerating: 'ç”Ÿæˆä¸­...',
    toolHistoryTitle: 'AIå®Ÿè¡Œå±¥æ­´',
    toolRunNow: 'ä»Šã™ãå®Ÿè¡Œ',
  },
  zh: {
    toolsInstalledTitle: 'å·²å®‰è£…å·¥å…·',
    toolsInstalledDescription: 'ä½ åœ¨æ­¤ workspace ä¸­ä½¿ç”¨çš„å·¥å…·ã€‚',
    toolsGenerate: 'ç”Ÿæˆ',
    toolsAdd: 'æ·»åŠ ',
    toolsActive: 'æ´»è·ƒ',
    toolsOpen: 'æ‰“å¼€',
    toolsEmptyTitle: 'å®‰è£…ä½ çš„ç¬¬ä¸€ä¸ªå·¥å…·',
    toolsEmptyDescription: 'ä½¿ç”¨ AI åˆ›å»ºå·¥å…·ï¼Œæˆ–ä»Žç›®å½•ä¸­é€‰æ‹©ä¸€ä¸ªã€‚',
    toolNewEntry: 'æ–°è®°å½•',
    toolAiIdeas: 'AI æƒ³æ³•',
    toolImportCsv: 'å¯¼å…¥ CSV',
    toolNoRecords: 'æ­¤å·¥å…·ä¸­è¿˜æ²¡æœ‰è®°å½•ã€‚',
    toolType: 'ç±»åž‹',
    toolDate: 'æ—¥æœŸ',
    toolActions: 'æ“ä½œ',
    toolForm: 'è¡¨å•',
    toolRun: 'è¿è¡Œ',
    toolGenerating: 'æ­£åœ¨ç”Ÿæˆ...',
    toolHistoryTitle: 'AI æ‰§è¡ŒåŽ†å²',
    toolRunNow: 'ç«‹å³è¿è¡Œ',
  },
}

const accountLocaleOverrides: Partial<Record<Locale, Partial<DashboardTranslations>>> = {
  fr: { accountMenu: 'Mon compte', accountMenuOpen: 'Ouvrir le menu du compte', accountPersonalData: 'DonnÃ©es personnelles', accountProfilePhoto: 'Photo de profil', accountSignOut: 'Se dÃ©connecter' },
  de: { accountMenu: 'Mein Konto', accountMenuOpen: 'KontomenÃ¼ Ã¶ffnen', accountPersonalData: 'PersÃ¶nliche Daten', accountProfilePhoto: 'Profilfoto', accountSignOut: 'Abmelden' },
  pt: { accountMenu: 'A minha conta', accountMenuOpen: 'Abrir menu da conta', accountPersonalData: 'Dados pessoais', accountProfilePhoto: 'Foto de perfil', accountSignOut: 'Terminar sessÃ£o' },
  ...
  pl: { accountMenu: 'Moje konto', accountMenuOpen: 'OtwÃ³rz menu konta', accountPersonalData: 'Dane osobowe', accountProfilePhoto: 'ZdjÄ™cie profilowe', accountSignOut: 'Wyloguj' },
  ...
  sv: { accountMenu: 'Mitt konto', accountMenuOpen: 'Ã–ppna kontomeny', accountPersonalData: 'Personuppgifter', accountProfilePhoto: 'Profilbild', accountSignOut: 'Logga ut' },
  da: { accountMenu: 'Min konto', accountMenuOpen: 'Ã…bn kontomenu', accountPersonalData: 'Personlige data', accountProfilePhoto: 'Profilfoto', accountSignOut: 'Log ud' },
  no: { accountMenu: 'Min konto', accountMenuOpen: 'Ã…pne kontomeny', accountPersonalData: 'Personopplysninger', accountProfilePhoto: 'Profilbilde', accountSignOut: 'Logg ut' },
  hu: { accountMenu: 'SajÃ¡t fiÃ³k', accountMenuOpen: 'FiÃ³kmenÃ¼ megnyitÃ¡sa', accountPersonalData: 'SzemÃ©lyes adatok', accountProfilePhoto: 'ProfilkÃ©p', accountSignOut: 'KijelentkezÃ©s' },
  cs: { accountMenu: 'MÅ¯j ÃºÄet', accountMenuOpen: 'OtevÅ™Ã­t nabÃ­dku ÃºÄtu', accountPersonalData: 'OsobnÃ­ Ãºdaje', accountProfilePhoto: 'ProfilovÃ¡ fotka', accountSignOut: 'OdhlÃ¡sit se' },
  sk: { accountMenu: 'MÃ´j ÃºÄet', accountMenuOpen: 'OtvoriÅ¥ ponuku ÃºÄtu', accountPersonalData: 'OsobnÃ© Ãºdaje', accountProfilePhoto: 'ProfilovÃ¡ fotka', accountSignOut: 'OdhlÃ¡siÅ¥ sa' },
  el: { accountMenu: 'ÎŸ Î»Î¿Î³Î±ÏÎ¹Î±ÏƒÎ¼ÏŒÏ‚ Î¼Î¿Ï…', accountMenuOpen: 'Î†Î½Î¿Î¹Î³Î¼Î± Î¼ÎµÎ½Î¿Ï Î»Î¿Î³Î±ÏÎ¹Î±ÏƒÎ¼Î¿Ï', accountPersonalData: 'Î ÏÎ¿ÏƒÏ‰Ï€Î¹ÎºÎ¬ Î´ÎµÎ´Î¿Î¼Î­Î½Î±', accountProfilePhoto: 'Î¦Ï‰Ï„Î¿Î³ÏÎ±Ï†Î¯Î± Ï€ÏÎ¿Ï†Î¯Î»', accountSignOut: 'Î‘Ï€Î¿ÏƒÏÎ½Î´ÎµÏƒÎ·' },
  fi: { accountMenu: 'Oma tili', accountMenuOpen: 'Avaa tilivalikko', accountPersonalData: 'HenkilÃ¶tiedot', accountProfilePhoto: 'Profiilikuva', accountSignOut: 'Kirjaudu ulos' },
  hr: { accountMenu: 'Moj raÄun', accountMenuOpen: 'Otvori izbornik raÄuna', accountPersonalData: 'Osobni podaci', accountProfilePhoto: 'Profilna fotografija', accountSignOut: 'Odjava' },
  bg: { accountMenu: 'ÐœÐ¾ÑÑ‚ Ð°ÐºÐ°ÑƒÐ½Ñ‚', accountMenuOpen: 'ÐžÑ‚Ð²Ð¾Ñ€Ð¸ Ð¼ÐµÐ½ÑŽÑ‚Ð¾ Ð½Ð° Ð°ÐºÐ°ÑƒÐ½Ñ‚Ð°', accountPersonalData: 'Ð›Ð¸Ñ‡Ð½Ð¸ Ð´Ð°Ð½Ð½Ð¸', accountProfilePhoto: 'ÐŸÑ€Ð¾Ñ„Ð¸Ð»Ð½Ð° ÑÐ½Ð¸Ð¼ÐºÐ°', accountSignOut: 'Ð˜Ð·Ñ…Ð¾Ð´' },
  sl: { accountMenu: 'Moj raÄun', accountMenuOpen: 'Odpri meni raÄuna', accountPersonalData: 'Osebni podatki', accountProfilePhoto: 'Profilna fotografija', accountSignOut: 'Odjava' },
  ja: { accountMenu: 'ãƒžã‚¤ã‚¢ã‚«ã‚¦ãƒ³ãƒˆ', accountMenuOpen: 'ã‚¢ã‚«ã‚¦ãƒ³ãƒˆãƒ¡ãƒ‹ãƒ¥ãƒ¼ã‚’é–‹ã', accountPersonalData: 'å€‹äººãƒ‡ãƒ¼ã‚¿', accountProfilePhoto: 'ãƒ—ãƒ­ãƒ•ã‚£ãƒ¼ãƒ«å†™çœŸ', accountSignOut: 'ã‚µã‚¤ãƒ³ã‚¢ã‚¦ãƒˆ' },
  zh: { accountMenu: 'æˆ‘çš„è´¦æˆ·', accountMenuOpen: 'æ‰“å¼€è´¦æˆ·èœå•', accountPersonalData: 'ä¸ªäººèµ„æ–™', accountProfilePhoto: 'å¤´åƒ', accountSignOut: 'é€€å‡ºç™»å½•' },
}
